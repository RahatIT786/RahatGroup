...
class QuotesEditComponent extends Component
{
    ...
    public function getAllCounts()
    {
        ...
        if($this->service_type_id != 12 && $this->service_type_id != 22 && $this->service_type_id != 23 && $this->service_type_id != 24 && $this->service_type_id != 25 && $this->service_type_id != 26 && $this->service_type_id != 27){
            if ($this->service_type_id == 2) {
                ...
                // (float)$this->tot_cost =  $this->tot_pkg_cost + $this->tot_ticket_cost + $this->tot_visa_price - $this->tot_pkg_commission;

                $user_cost = $this->tot_pkg_cost;
                (float)$this->tot_cost =  $this->tot_pkg_cost - $this->tot_pkg_commission;
    ...
    {
        return view('agent.quotes.quotes-edit-component');
    }
}
