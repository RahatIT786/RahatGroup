...
class CallUsBackComponent extends Component
{
    ...
    public function save()
    {
        ...
        if ($validated) {
            ...
            session()->flash('callus_back_success', 'Your Inquiry Number is <strong style="color: blue;">' . Helper::uppercase($validated['unique_id']) . '</strong>' .
    ...
    {
        return view('user-front.call-us-back-component');
    }
}
