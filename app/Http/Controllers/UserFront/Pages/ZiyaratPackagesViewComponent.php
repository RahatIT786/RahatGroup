...
class ZiyaratPackagesViewComponent extends Component
{
    use WithFileUploads;
    ...
    //Download Ziyarat Package in PDF format
	public function downloadZiyaratPackage($packageId)
	{
		...
		return $pdf->download('ziyarat-package.pdf');
    ...
    {
        return view('user-front.pages.ziyarat-packages-view-component');
    }
}
