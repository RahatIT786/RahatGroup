...
class UmrahPackageModal extends Component
{use WithFileUploads;
    ...
    public function save()
    {
        ...
        if ($validated) {
            ...
            Mail::to($randomStaff->email)->cc($adminEmail)->send(new UmrahPackageInquiryEmail($umrahpackage, $randomStaff, $adminSetting, $adminwhatsapp));
    ...
    {
        return view('user-front.pages.umrah-package-modal');
    }
}
