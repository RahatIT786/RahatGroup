...
use App\Mail\ZiyaratInquiryEmail;
...
class ZiyaratPackageViewModalComponent extends Component
{
    ...
    public function generateCaptcha()
    {
        ...
        imagedestroy($image);
        session(['book_now_umrah_captcha_code' => $text]);
    }
    ...
    public function save()
    {
        ...
        if ($this->userInput !== session('book_now_umrah_captcha_code')) {
        ...
        if ($validated) {
            ...
            Mail::to($randomStaff->email)->cc($adminEmail)->send(new ZiyaratInquiryEmail($ziyaratpackages, $randomStaff, $adminSetting, $adminwhatsapp));
    ...
    {
        return view('user-front.pages.ziyarat-package-view-modal-component');
    }
}
