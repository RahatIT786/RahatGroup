...
class HajjPackageViewModalComponent extends Component
{
    ...
    public function save()
    {
        ...
        if ($validated) {
            ...
            Mail::to($randomStaff->email)->cc($adminEmail)->send(new HajjInquiryEmail($hajjpackages, $randomStaff,$adminSetting, $adminwhatsapp));
    ...
    {
        return view('user-front.pages.hajj-package-view-modal-component');
    }
}
