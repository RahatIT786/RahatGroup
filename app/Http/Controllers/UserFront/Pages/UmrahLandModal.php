...
class UmrahLandModal extends Component
{
    use WithFileUploads;
    ...
    public function save()
    {
        ...
        if ($validated) {
            ...
            // Mail::to($randomStaff->email)->cc($adminEmail)->send(new UmrahPackageInquiryEmail($umrahpackage, $randomStaff));
    ...
    {
        return view('user-front.pages.umrah-land-modal');
    }
}
