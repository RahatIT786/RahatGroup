...
class UmrahLandViewComponent extends Component
{
    ...
    public function downloadPackage($packageId)
    {
        ...
        // foreach ($data['package_details'] as $detail) {

        //     if (is_numeric($detail['makkah_hotel_star_rating']) && $detail['makkah_hotel_star_rating'] >= 1 && $detail['makkah_hotel_star_rating'] <= 5) {
        //         for ($i = 0; $i < $detail['makkah_hotel_star_rating']; $i++) {
        //             dd((int)$detail['makkah_hotel_star_rating']);
        //         }
    ...
    {
        return view('user-front.pages.umrah-land-view-component');
    }
}
