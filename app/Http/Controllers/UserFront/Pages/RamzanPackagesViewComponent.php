...
class RamzanPackagesViewComponent extends Component
{
    ...
    public function selectDate()
    {
         ...
         ->where('dept_date', '>', now())
         ->active();
         // Filter the same query further for flight_ids on travel_date
         if ($this->travel_date) {
    ...
    public function downloadRamzanPackage($packageId)
    {
        ...
        return $pdf->download('ramzan-package.pdf');
    }
    #[Layout('user-front.layouts.app')]
    public function render()
    {
        return view('user-front.pages.ramzan-packages-view-component');
    }
}
