...
{
    public $shoppings, $shp, $id, $shp_qty = 0, $tot_price = 0, $shopping_details = [], $grand_total = 0,$modalData;
    ...
    {
        $this->modalData = Shopping::findOrFail($key);
    }

    #[Layout('user-front.layouts.app')]
    public function render()
    {
        return view('user-front.pages.shopping-list-component');
    }
}
