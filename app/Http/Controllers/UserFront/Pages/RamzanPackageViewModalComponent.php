...
use App\Mail\RamzanInquiryEmail;
...
class RamzanPackageViewModalComponent extends Component
{
    ...
    public function save()
    {
        ...
        if ($validated) {
            ...
            Mail::to($randomStaff->email)->cc($adminEmail)->send(new RamzanInquiryEmail($ramzanpackages, $randomStaff, $adminSetting, $adminwhatsapp));
    ...
    {
        return view('user-front.pages.ramzan-package-view-modal-component');
    }
}
