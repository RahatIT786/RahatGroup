...
class ZiyaratPackagesComponent extends Component
{
    ...
    public function putInCache($value, $flag = null)
    {
        ...
        if (!empty($flag)) return redirect()->route('customer.ziyaratPackagesView', ['id' => $flag]);
    }
    ...
    public function getPackageType($packagetype)
    {
        ...
        $this->packages = $this->getPackagess();
    }
    ...
    {
        return view('user-front.pages.ziyarat-packages-component', [
