...
class ForexComponent extends Component
{
    ...
    public function save()
    {
        ...
        if ($validatedData) {
            ...
            // Mail::to($randomStaff->email)->send(new ForexInquiryEmail($forexenquiry, $randomStaff));
            Mail::to('joddhajitputel143@gmail.com')->send(new ForexInquiryEmail($forexenquiry, $randomStaff));
    ...
    {
        return view('user-front.forex-component');
    }
}
