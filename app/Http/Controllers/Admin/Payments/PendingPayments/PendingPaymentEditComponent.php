...
class PendingPaymentEditComponent extends Component
{   
    use LivewireAlert;
    public $agencies, $agency_id,$selected_booking, $bookings = [], $booking_id, $tot_cost, $tot_paid = 0, $balance,$companies;
    ...
    {       
        ...
        $this->selected_booking = Booking::where('id', $payment->booking_id)->first();
        
        // Set the agency_id and company_name from the fetched booking and payment
        $this->agency_id = $this->selected_booking->agency_id;
        ...
        // dd($this->bookings);
        $this->booking_id = $payment->booking->booking_id;
        ...
        $all_payments = Payment::where('booking_id',$this->selected_booking->id)->get();
    ...
    {   
        ...
        $bookingData = Booking::whereId($this->selected_booking->id)->first();
        ...
        $paid_amount = Payment::where('id', $this->payment_id)
        ->where('is_paid', '1')
        ...
        return redirect()->route('admin.payment.pending');

    }
    public function render()
    {
        return view('admin.payments.pending-payments.pending-payment-edit-component');
    }
}
