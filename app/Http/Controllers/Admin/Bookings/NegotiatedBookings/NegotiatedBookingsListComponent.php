...
namespace App\Http\Controllers\Admin\Bookings\NegotiatedBookings;
...
class NegotiatedBookingsListComponent extends Component
{
    ...
    {
        return view('admin.bookings.negotiated-bookings.negotiated-bookings-list-component', [
