...
class UmrahComponent extends Component
{
    ...
    public $search_package = '', $flavour_changed = false;
    ...
    public function mount()
    {
        ...
        $this->fetchPackages();
        // $this->totalPackages = Packages::count();
    ...
    public function putInCache($value, $flag = null)
    {
        ...
        if (!empty($flag)) return redirect()->route('umrahPackagesView', ['id' => $flag]);
    }
    ...
    {
        return view('user.pages.umrah-component', [
