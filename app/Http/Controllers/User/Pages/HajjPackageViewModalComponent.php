...
class HajjPackageViewModalComponent extends Component
{
    use WithFileUploads;
    ...
    public function save()
    {
        ...
        if ($validated) {
            ...
            Mail::to($randomStaff->email)->cc($adminEmail)->send(new HajjPackagesInquiryEmail($hajjpackages, $randomStaff,$adminSetting,$adminwhatsapp));
    ...
    {
        return view('user.pages.hajj-package-view-modal-component');
    }
}
