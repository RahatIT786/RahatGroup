...
use App\Mail\ZiyaratPackagesInquiryEmail;
use App\Models\AdminSetting;

class ZiyaratPackageViewModalComponent extends Component
{
    use WithFileUploads;
    ...
    public function mount($id, $travel_date, $city, $airline_id)
    {
    ...
    public function generateCaptcha()
    {
        ...
        imagedestroy($image);
        session(['book_now_ziyarat_captcha_code' => $text]);
    }
    ...
    public function save()
    {
        ...
        if ($this->userInput !== session('book_now_ziyarat_captcha_code')) {
        ...
        if ($validated) {
            $ziyaratpackages =  Bookingenquiry::create($validated);
            ...
            Mail::to($randomStaff->email)->cc($adminEmail)->send(new ZiyaratPackagesInquiryEmail($ziyaratpackages, $randomStaff, $adminSetting, $adminwhatsapp));
    ...
    {
        return view('user.pages.ziyarat-package-view-modal-component');
    }
}
