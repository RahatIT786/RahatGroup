...
use App\Mail\UmrahPackagesInquiryEmail;
use App\Models\AdminSetting;

class UmrahPackageViewModalComponent extends Component
{
    use WithFileUploads;
    ...
    public function save()
    {
        ...
        if ($validated) {
            $umrahpackage = Bookingenquiry::create($validated);
            ...
            Mail::to($randomStaff->email)->cc($adminEmail)->send(new UmrahPackagesInquiryEmail($umrahpackage, $randomStaff, $adminSetting, $adminwhatsapp));
    ...
    {
        return view('user.pages.umrah-package-view-modal-component');
    }
}
