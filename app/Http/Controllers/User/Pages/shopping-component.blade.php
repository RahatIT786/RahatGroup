<main class="cAJbgc" style="margin-top: 0px;">
    ...
    <section class="shopping-page-container bg-light py-5">
        <div class="container">
                    ...
                    <div class="row mb-4">
                        {{-- <div class="col-md-12">
                            <select class="custom-select w-100">
                                <option> Select Shopping Item </option>
                                <option>Nabi booty</option>
                                <option> Maryam Booti.</option>
                                <option>Zamzam water</option>
                                <option>Aswad Surma</option>
                                <option>Rosary (Tasbeeh)</option>
                                <option>Janamaaz - Musalla - Prayer Mats</option>
                                <option>Jannatul Firdaus - Itar from Madina</option>
                                <option>Miswaak Sticks</option>
                                <option>Elegant Golden incense burner for bakhoor</option>
                                <option>Electric Oud Burner Holder - DIAMOND</option>
                                <option>Electric Oud Burner Holder Incense - GOLD</option>
                                <option>Magic Coal for Oud Burner</option>
                                <option> BURNING BAKHOOR INCENSE CHIPS OUDH</option>
                            </select>
                        </div> --}}
                    </div>
                </div>
                    ...
                    <div class="white-bg-box">
                        <div class="row mx-0">
                            ...
                            <div class="col-md-4 px-0 border-right">
                                <div class="pad15">
                                    <h5 class="h5 pro-title mb-0">{{ $shopping->name }}</h5>
                            ...
                            <div class="col-md-2 px-0 border-right">
                                <div class="pad15">
                                    <p class="pro-price"><small class="font12">Price</small><span
                            ...
                            <div class="col-md-2 px-0">
                                <div class="pad15">
                                    <p class="pro-price text-right"><small class="font12">Total Price</small><span
                                            class="d-block font-weight-bold text-success">Rs.
            ...
            @endforeach <!-- Add this line to close the loop -->
            <div class="shop-pro-row">
                <div class="white-bg-box">
                    <div class="row mx-0">
                        <div class="col-md-12 px-0">
                            <div class="pad15 text-right">
                                <span class="pro-total-price font-weight-bold text-success">Total Amount Rs. <span
                ...
                <div class="col-md-12 px-0">
                    <div class="text-right" id="book_btn">
                        <button type="submit" href="javascript:void(0);" font-size="smallest" data-toggle="modal"
                            data-target="#publicationModal" class="btn secondary-btn" name="btn_kit_enquiry">Enquiry
                            Now</button>
                        <button type="submit" class="btn default-btn" name="btn_kit_submit">Book Now</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        function updateQuantity(id, change) {
            ...
            get_shop_price({{ $shopping->price }}, 0, id);
        }
        ...
        function toggleText(id) {
            ...
            if (readMore.style.display !== 'none') {
                // Load the full text
                textDiv.innerHTML = `{!! \App\Helpers\Helper::limitTextReadMore($shopping->description, 120, '...', false) !!}`;
                readMore.style.display = 'none';
                readLess.style.display = 'inline';
            } else {
                // Load the truncated text
                textDiv.innerHTML = `{!! \App\Helpers\Helper::limitTextReadMore($shopping->description, 120) !!}`;
