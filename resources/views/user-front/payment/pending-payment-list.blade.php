                                                    ...
                                                    @if ($PendingPayments && $PendingPayments->count())
                                                        @foreach ($PendingPayments as $key => $PendingPayment)
                                                            <tr>
                                                                ...
                                                                @endphp
                                                                @if (array_key_exists($PendingPayment->payment_status, $statusLabels))
                                                                    <div
                                                                        class="pointer badge {{ $statusLabels[$PendingPayment->payment_status]['class'] }}">
                                                                        {{ $statusLabels[$PendingPayment->payment_status]['label'] }}
                                                                    </div>
                                                                @endif
                                                            </td> --}}
                                                                <td>
