<div class="bg-light py-5">
        ...
        <div class="container">
            <nav class="breadcrumbs">
                <span>
                    ...
                    <span class="breadcrumb-text">
                        <a href="{{ route('customer.hajjPackage') }}">Package List</a>
                    </span>
                    <span class="breadcrumb-separator"></span>
                ...
                <div class="col-md-5">
                    ...
                    <div class="topmargin20">
                        <a class="downloaditnerybtn"
                            href="{{ route('customer.downloadHajjPackage', $packages->id) }}" type="button"
    ...
    @livewire(
        'user-front.pages.hajj-package-view-modal-component',
        [
            'id' => $packageId,
