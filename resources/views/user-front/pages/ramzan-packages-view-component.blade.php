<div class="bg-light py-5">
        ...
        <div class="container">
            <nav class="breadcrumbs">
                <span>
                    ...
                    <span class="breadcrumb-text">
                        <a href="{{ route('customer.ramzanPackages') }}">Package List</a>
                    </span>
                    <span class="breadcrumb-separator"></span>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" wire:model='city_id' wire:change="selectCity"
                                        id="city_id">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" wire:model='airline_id' wire:change="selectFlight"
                                        id="airline_id">
                        ...
                        <div class="row gx-3">
                            ...
                            <div class="col-3">
                                @if ($pnr->isNotEmpty())
                                    <div id="MainContent_divAvailableSeat" class="price">
                                        <strong>{{ $avail_seats }}</strong>
                                    </div>
                                    <div class="pricefromtext" style="font-weight: bold;">
                                        Seats
                                    </div>
                                @else
                                    <div>Seats Not found.</div>
                                @endif
                            </div>
                            ...
                            <div class="col-5 text-end">
                                @php
                                    ...
                                    $props = $isValid ? "data-toggle='modal' data-target='#ramzanModal'" : '';
                                @endphp
                    ...
                    <div class="topmargin20">
                        <a class="downloaditnerybtn"
                            href="{{ route('customer.downloadRamzanPackage', $packages->id) }}" type="button"
                            id="lnkDownloadItinerary">Download Itinerary <i class="fa fa-download"></i></a>
                    </div>
                    <div style="margin-top: 40px">
                        @if ($packages)
                            ...
                            <a href="javascript:void(0)" id="read-less-{{ $id }}" style="display:none;"
    ...
    @livewire(
        'user-front.pages.ramzan-package-view-modal-component',
        [
            'id' => $packageId,
