...
<body>
    ...
    <div style="width:720px;margin:0px auto;padding:0px;border:1px solid #e4e4e4;">
        ...
        <div style="background:#006a20;padding-top:25px;padding-left:25px;padding-right:25px;position:relative;border-bottom:8px solid #000000;">
            <div style="background:url({{ public_path('assets/img/itinerary-img/green-bg.png') }}) repeat-x;background-size: cover;width:100%;height:52px;position:absolute;left:0px;top:-50px;padding-bottom:1px;">
            </div>
                        ...
                        <td valign="top" style="width:60%;padding-bottom:15px;padding-left:50px;">
                            <table style="width:100%;">
                                <tbody>
                                    <tr>
                                        <td valign="top" width="72px">
                                            <img src="{{ public_path('assets/img/itinerary-img/map-icon.png') }}" width="53px" height="51px" />
                                        </td>
                                        <td valign="top">
                                            <div style="font-size:20px;font-weight:bold;color:#3e3e3e;padding-bottom:10px;">
                                                DESTINATIONS</div>
        ...
        <div style="padding-top:25px;padding-bottom:25px;padding-left:25px;padding-right:25px;position:relative;">
            ...
            <table style="width:100%;position:relative;margin-bottom:58px;">
                <tbody>
                    ...
                    <tr>
                        <td colspan="4" style="font-size:20px;font-weight:bold;color:#ffb300;padding-bottom:20px;">
                            {{ $detail['package_type'] }}</td>
                    </tr>
                    <tr>
                        <td colspan="4" style="font-size:18px;font-weight:bold;color:#60b739;padding-top:20px;padding-bottom:20px;">
                            MAKKAH</td>
                    </tr>
                    <tr>
                        @php
                        ...
                        @endphp
                        <td valign="top" style="padding-right:8px;padding-bottom:20px;border-bottom:1px solid #d9e3e2;width:158px;">
                            @if ($makkahHotelImageSrc)
                            <img src="{{ $makkahHotelImageSrc }}" width="150px" height="112px" />
                            @endif
                        </td>
                        <td valign="top" style="padding-top:8px;padding-bottom:20px;border-bottom:1px solid #d9e3e2;">
                            <div style="font-size:18px;font-weight:bold;color:#000000;padding-bottom:10px;">
                                {{ $detail['makkahotel'] }}<small style="color:#bc2e31;font-weight:normal;font-size:14px;">(OR Similar)</small>
                            </div>
                            <div>

                                @if (is_numeric($detail['makkah_hotel_star_rating']) &&
                                (int) $detail['makkah_hotel_star_rating'] >= 1 &&
                                (int) $detail['makkah_hotel_star_rating']
                                <= 5) @for ($i=0; $i < (int) $detail['makkah_hotel_star_rating']; $i++) <img src="{{ public_path('assets/img/itinerary-img/star-icon.png') }}" width="20px" height="20px" />
                                @endfor
                                @else
                    ...
                    <tr>
                        ...
                        <td valign="top" style="padding-top:8px;padding-bottom:20px;border-bottom:1px solid #d9e3e2;">
                            <div style="font-size:18px;font-weight:bold;color:#000000;padding-bottom:10px;">
                                {{ $detail['madinahotel'] }}<small style="color:#bc2e31;font-weight:normal;font-size:14px;">(OR Similar)</small>
                            </div>
                            <div>

                                @if (is_numeric($detail['madinah_hotel_star_rating']) &&
                                (int) $detail['madinah_hotel_star_rating'] >= 1 &&
                                (int) $detail['madinah_hotel_star_rating']
                                <= 5) @for ($i=0; $i < (int) $detail['madinah_hotel_star_rating']; $i++) <img src="{{ public_path('assets/img/itinerary-img/star-icon.png') }}" width="20px" height="20px" />
                                @endfor
                                @else
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding-bottom:10px;">
                            <div style="font-size:18px;color:#000000;font-weight:normal;">Package Type :<span style="font-style:italic;color:#006a20;font-weight:normal;">{{ $detail['package_type'] }}</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            @if($detail['single'] > 0)
                                <div style="display:inline-block;vertical-align:top;text-align:center;width:138px;border-radius:20px;background:#e9ffd0;border-bottom:3px solid #8bc34a;font-weight:normal;margin-right:16px;margin-bottom:45px;">
                                    <div style="border:1px solid #cdff94;border-radius:20px;">
                                        <div style="padding:15px 5px;border-bottom:1px dashed #006a20;letter-spacing: 1.5px;font-size:16px;color:#000000;">
                                            Single</div>
                            ...
                            @endif
                            @if($detail['d_share'] > 0)
                                <div style="display:inline-block;vertical-align:top;text-align:center;width:138px;border-radius:20px;background:#fff1d6;border-bottom:3px solid #f44336;font-weight:normal;margin-right:16px;margin-bottom:45px;">
                            ...
                            @endif
                            @if($detail['t_share'] > 0)
                                <div style="display:inline-block;vertical-align:top;text-align:center;width:138px;border-radius:20px;background:#f8ffcf;border-bottom:3px solid #ffb300;font-weight:normal;margin-right:16px;margin-bottom:45px;">
                            ...
                            @endif
                            @if($detail['g_share'] > 0)
                                <div style="display:inline-block;vertical-align:top;text-align:center;width:138px;border-radius:20px;background:#e2e6ff;border-bottom:3px solid #25476a;font-weight:normal;margin-right:16px;margin-bottom:45px;">
                                    <div style="border:1px solid #4383c5;border-radius:20px;">
                                        <div style="padding:15px 5px;border-bottom:1px dashed #006a20;letter-spacing: 1.5px;font-size:16px;color:#000000;">
                                            Sharing</div>
                                        <div style="padding:15px 5px;font-size:16px;color:#000000;">INR
                                            {{ number_format($detail['g_share'], 2) }}</div>
                                    </div>
                                </div>
                            @endif
                            @if($detail['child_with_bed'] > 0)
                                <div style="display:inline-block;vertical-align:top;text-align:center;width:138px;border-radius:20px;background:#f0faff;border-bottom:3px solid #03a9f4;font-weight:normal;margin-right:16px;margin-bottom:45px;">
                                    <div style="border:1px solid #79d5ff;border-radius:20px;">
                                        <div style="padding:15px 5px;border-bottom:1px dashed #006a20;letter-spacing: 1.5px;font-size:16px;color:#000000;">
                                            CWB</div>
                                        <div style="padding:15px 5px;font-size:16px;color:#000000;">INR
                                            {{ $detail['child_with_bed'] }}</div>
                                    </div>
                                </div>
                            @endif
                            @if($detail['child_no_bed'] > 0)
                                <div style="display:inline-block;vertical-align:top;text-align:center;width:138px;border-radius:20px;background:#fff1f6;border-bottom:3px solid #ab47bc;font-weight:normal;margin-right:16px;margin-bottom:45px;">
                                    <div style="border:1px solid #d85eec;border-radius:20px;">
                                        <div style="padding:15px 5px;border-bottom:1px dashed #006a20;letter-spacing: 1.5px;font-size:16px;color:#000000;">
                                            CWOB</div>
                                        <div style="padding:15px 5px;font-size:16px;color:#000000;">INR
                                            {{ $detail['child_no_bed'] }}</div>
                                    </div>
                                </div>
                            @endif
                            @if($detail['infant'] > 0)
        ...
        <div style="padding-top:25px;padding-bottom:25px;padding-left:25px;padding-right:25px;position:relative;">
            ...
            <div style="width:100%;background:#006a20;margin-top:20px;margin-bottom:20px;"></div>
            <table style="width:100%;position:relative;margin-bottom:58px; page-break-inside: avoid;">
                <tbody>
                    <tr>
                        <td valign="top" style="width:50%;padding-right:20px;text-align:left;">
                            <div style="font-size:20px;font-weight:bold;color:#60b739;padding-bottom:10px;">INCLUSIONS
                            </div>
                            <ul style="color:#000000;font-size:16px;padding-left: 10px;margin: 0px;line-height: 20px;">
                                {!! Helper::cleanHtmlForPdf($inclusion) !!}
                            </ul>
                        </td>
                        <td valign="top" style="width:50%;text-align:left;">
                            ...
                            <ul style="color:#000000;font-size:16px;padding-left: 10px;margin: 0px;line-height: 20px;">
                                {!! Helper::cleanHtmlForPdf($exclusion) !!}
                            </ul>
                        </td>
                    </tr>
                </tbody>
