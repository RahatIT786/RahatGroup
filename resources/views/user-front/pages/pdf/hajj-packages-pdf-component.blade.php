                ...
                <tbody>
                    ...
                    <tr>
                        {{-- <td colspan="2" style="color:#ffffff;font-size:17px;padding-top:10px;padding-bottom:10px;border-top:1px dashed #ffffff;border-bottom:1px dashed #ffffff;">
							14 Nights / 15 Days - <span style="color:#ffe000;">Ex Mumbai</span>
						</td> --}}
                    </tr>
                    <tr>
                        {{-- <td colspan="2" align="center" style="text-align:center;color:#ffe000;font-size:12px;padding-top:15px;padding-bottom:15px;">
							Also available from Ex Ahmedabad, Ex Delhi, Ex Hyderabad Only
						</td> --}}
                    </tr>
                </tbody>
            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <div style="font-size:20px;font-weight:bold;color:#3e3e3e;padding-bottom:10px;">
                                                DESTINATIONS</div>
                                            <div style="font-size:17px;color:#695f5f;padding-bottom:10px;">Makkah(7)
                                                Madinah(7)</div>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    {{-- <tr>
                        <td style="padding-bottom:60px;">
                            <div style="font-size:19px;color:#737373;font-weight:bold;padding-bottom:8px;">DEPARTURE
                                DATES : <span style="font-style:italic;color:#006a20;font-weight:normal;"><strong>13,
                                        20, 27</strong> Jul 2024 | <strong>3, 10, 17, 24, 31</strong> Aug 2024 |
                                    <strong>21, 28</strong> Sep 2024 | <strong>5, 12</strong> Oct 2024</span></div>
                            <div style="font-size:19px;color:#737373;font-weight:bold;padding-bottom:8px;">DEPARTURE
                                CITY : <span style="font-style:italic;color:#006a20;font-weight:normal;">Ex
                                    Mumbai</span></div>
                            <div style="font-size:19px;color:#737373;font-weight:bold;padding-bottom:8px;">AIRLINE :
                                <span style="font-style:italic;color:#006a20;font-weight:normal;">VISTARA
                                    AIRWAYS</span>
                            </div>
                        </td>
                    </tr> --}}
