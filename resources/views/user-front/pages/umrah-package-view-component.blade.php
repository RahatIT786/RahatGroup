<div class="bg-light py-5">
        ...
        <div class="container">
            <nav class="breadcrumbs">
                <span>
                    ...
                    <span class="breadcrumb-text">
                        <a href="{{ route('customer.umrahPackage') }}">Package List</a>
                    </span>
                    <span class="breadcrumb-separator"></span>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="packagedetpricebox">
                        ...
                        <div class="row gx-3">
                            ...
                            <div class="col-5 text-end">
                                @php
                                    $isValid = !empty($city_id) && !empty($travel_date) && !empty($airline_id) && !empty($selectedPackageFlavourId);
                                    $props = $isValid ? "data-toggle='modal' data-target='#umrahModal'" : '';
                    ...
                    <div class="topmargin20">
                        <a class="downloaditnerybtn" href="{{ route('customer.downloadUmrahPackage', $packages->id) }}"
    ...
    @livewire(
        'user-front.pages.umrah-package-modal',
        [
            'id' => $packageId,
