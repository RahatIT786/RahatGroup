                                                    ...
                                                    <div class="package_text">
                                                        <div class="">
                                                            @if ($package->pkgImages->isNotEmpty())
                                                                <a
                                                                    href="{{ route('customer.umrahLandPackagesView', ['id' => $package->id, 'type' => $selectedFlavour[$key]['pkg_type_id']]) }}"><img
                                                    ...
                                                    <div class="compare text-right">
                                                        ...
                                                        <div class="mt-2">
                                                            <a class="mdr svmdr detail_link detailbtn-mobile secondary-btn btn btn-block py-2 px-2"
                                                                href="{{ route('customer.umrahLandPackagesView', ['id' => $package->id, 'type' => $selectedFlavour[$key]['pkg_type_id']]) }}">View
                                                                Details</a>
                                                        </div>
                                                        <div class="mt-2">
