                ...
                <div class="col-md-12">
                    <nav class="breadcrumbs mb-4">
                        <span>
                            ...
                            <span class="breadcrumb-text">Publication</span>
                        </span>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="white-bg-box">
                        <div class="row mx-0">
                            ...
                            <div class="col-md-4 px-0 border-right">
                                <div class="pad15">
                                    <h5 class="h5 pro-title mb-0"><strong>{{ $publication->name }}</strong></h5>
                                    <div class="pro-short-desc mb-2 mt-2">
                                        ...
                                        <a href="javascript:void(0)" id="read-less-{{ $key }}"
                                            ...
                                            data-toggle="modal"
                                            wire:click="getModaldescription({{ $publication->id }})"
                ...
                <div class="col-md-12 px-0">
                    <div class="text-right" id="book_btn">
                        <button type="submit" href="javascript:void(0);" font-size="smallest" data-toggle="modal"
                            data-target="#custPublicationModal" class="btn secondary-btn"
