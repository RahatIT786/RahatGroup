<div class="bg-light py-5">
        ...
        <div class="container">
            <nav class="breadcrumbs">
                <span>
                    ...
                    <span class="breadcrumb-text">
                        <a href="{{ route('customer.umrahLandPackages') }}">Package List</a>
                    </span>
                    <span class="breadcrumb-separator"></span>
                        ...
                        <div class="row gx-3">
                            ...
                            <div class="col-5 text-end">
                                @php
                                    ...
                                    $props = $isValid ? "data-toggle='modal' data-target='#umrahLandModal'" : '';
                                @endphp
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="packagehotelboxname">
                                                                <h5>
                                                                    <a href="{{ route('hotelDetail', ['id' => $makkahotel->id]) }}"
                                                ...
                                                <div class="packagehotelbox">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="packagehotelboxname">
                                                                <h5>
                                                                    <a href="{{ route('hotelDetail', ['id' => $madinahotel->id]) }}"
    ...
    @livewire(
        'user-front.pages.umrah-land-modal',
        [
            'id' => $packageId,
