<div class="modal fade" id="hajjModal" tabindex="-1" aria-labelledby="hajjModalTitle" style="display: none;"
            ...
            <div class="modal-body">
                <form name="frm_food_enquiry" wire:submit.prevent="save">
                    ...
                    <div class="text-center">
                        <button type="submit" name="btn_quick_submit" class="btn secondary-btn"
                            style="background-position: 300% 100% !important;">Submit</button>
                    </div>
                </form>
            </div>
        </div>
