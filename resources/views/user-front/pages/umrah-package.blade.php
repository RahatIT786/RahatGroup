            ...
            <div class="package_list_section" id="package_list">
                                                    ...
                                                    <div class="package_text">
                                                        <div class="">
                                                            @if ($package->pkgImages->isNotEmpty())
                                                                <a
                                                                    href="{{ route('customer.umrahPackageView', ['id' => $package->id, 'type' => $selectedFlavour[$key]['pkg_type_id']]) }}"><img
                                                    ...
                                                    <div class="compare text-right">
                                                        ...
                                                        <p class="mb-0">
                                                            ...
                                                            <span class="package_price">
                                                                ...
                                                                <span
                                                                    wire:loading.remove>{{ number_format($this->selectedFlavourPrice[$key], 2) }}</span>
                                                            </span><br>
                                                            <small>Per Person</small>
                                                        </p>
                                                        <div class="mt-2">
                                                            <a class="mdr svmdr detail_link detailbtn-mobile secondary-btn btn btn-block py-2 px-2"
                                                                href="{{ route('customer.umrahPackageView', ['id' => $package->id, 'type' => $selectedFlavour[$key]['pkg_type_id']]) }}">View
                                                                Details</a>
                                                        </div>
                                                        <div class="mt-2">
                ...
                @if (count($packages) < $totalPackages)
                    <div class="text-center my-4">
                        <button class="btn default-btn" type="button" wire:click="loadMore">Load More</button>
                    </div>
                @endif
            </div>
        </div>
