                                ...
                                <div class="settings-inner-blk p-0">
                                    <div class="comman-space pb-0">
                                        <div
                                            ...
                                            <div>
                                                {{-- <a class="btn btn-primary" href="{{ route('customer.booking.create') }}"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 20%;">
                                                                <b>
                                                                    ...
                                                                    @endif
                                                                    {{ $booking->servicetype != null ? $booking->servicetype->name : '-' }}</span>
                                                            </td>
                                                            <td style="width: 20%;">
                                                            ...
                                                            @php
                                                                ...
                                                                //    dd(var_dump($balance),var_dump($booking->full_payment_discount));
                                                                $abc =
                                                                    $balance - round($booking->full_payment_discount);
                                                                // dd($abc);
                                                                // dd($balance,$booking->tot_cost,$tot_paid,$booking->full_payment_discount);
                                                            @endphp
                                                                ...
                                                                <div class="ticket-grp mb-2 has-submenu">
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('customer.bookings.add.pax', ['booking_id' => $booking->id]) }}">Add
                                                                            Passenger
                                                                            Details</a>
                                                                        <a class="dropdown-item"
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                            ...
                                                                            Details</a>
                                                                        <a class="dropdown-item"
                                                                            @if ($booking->is_active == 1) href="{{ route('customer.bookings.add.payment', ['booking_id' => $booking->id]) }}"
                                                                            @else
                                                ...
                                                <div class="row" style="width: 100%">
                                                    <div class="col-md-3">
                                                        <div class="mb-4">
                                                            ...
                                                            <div>
                                                                {{ $booking_modal_data->pnr->flight->flight_name ?? '' }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="mb-4">
                                                            ...
                                                            <div>
                                                                {{ $booking_modal_data->pnr->flight->flight_code ?? '' }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="mb-4">
                                                            ...
                                                            <div>{{ $booking_modal_data->pnr->flight_type ?? '' }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="mb-4">
                                                            ...
                                                            <div>
                                                                @if ($booking_modal_data && $booking_modal_data->pnr)
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-4">
                                                            ...
                                                            <div>
                                                                @if ($booking_modal_data && $booking_modal_data->pnr)
                                                                    {{ $booking_modal_data->pnr->return_date ? Helper::appDateFormat($booking_modal_data->pnr->return_date) : 'N/A' }}
                                                                    </br>
                                                                    {{ $booking_modal_data->pnr->return_time ?? 'N/A' }}
                                                                @else
                                                                    N/A
                                                                @endif
                                                            </div>
                                                ...
                                                <div class="row" style="width: 100%">
                                                    <div class="col-md-3">
                                                        <div class="mb-4">
                                                            ...
                                                            <div>{{ $booking_modal_data->package->name ?: 'N/A' }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
