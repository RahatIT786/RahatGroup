                    ...
                    <div class="col-12 ">
                        <div class="card card-primary">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                @if ($i == 1)
                                    <a href="{{ route('customer.bookings.index') }}" class="btn btn-danger"><i
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                @if ($passengerDetails[$i]['dateOfBirth'])
                                                    <span class="v-msg-500 text-danger">{{ $agevalidation[$i] }}</span>
                                                    <span
                                    ...
                                    <div class="col-4 mb-2">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <span class="v-msg-500 text-danger">Acceptable Formats : (.jpg or .png
                                                    max
                                    ...
                                    <div class="col-3 mb-2">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <span class="v-msg-500 text-danger">Acceptable Formats : (.jpg or .pdf
                                                    max
