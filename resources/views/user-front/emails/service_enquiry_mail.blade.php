        ...
        <div class="email-container">
            <div style="padding: 20px;">
                ...
                <div class="mailheader">
                    ...
                    <p style="margin:0px;color:#206099;font-size:16px;">We have received Inquiry for Service</p>
                </div>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:0;">
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue">
                                    <strong>{{ Helper::uppercase($serviceEnquiry->unique_id) }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Full Name</div>
                                <div class="textvalue"><strong>{{ $serviceEnquiry->name }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Email Id</div>
                                <div class="textvalue"><strong>{{ $serviceEnquiry->email }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Mobile No</div>
                                <div class="textvalue"><strong>{{ $serviceEnquiry->mobile_num }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Whatsapp No</div>
                                <div class="textvalue"><strong>{{ $serviceEnquiry->whatsapp_num }}</strong></div>
                            </td>

                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Booking Date</div>
                                <div class="textvalue">
                                    <strong>{{ $serviceEnquiry->booking_date ? Helper::formatCarbonDate($serviceEnquiry->booking_date) : '' }}</strong>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue"><strong>{{ $serviceEnquiry->no_of_guest }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Address</div>
                                <div class="textvalue"><strong>{{ $serviceEnquiry->address }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Comments</div>
                                <div class="textvalue"><strong>{{ $serviceEnquiry->remarks }}</strong></div>
                            </td>
                        </tr>
                    </table>
                </div>
