        ...
        <div class="email-container">
            <div style="padding: 20px;">
                <div style="text-align: center;background-color: #ababab;margin-bottom:20px;">
                    <img alt="prophet-mosque" src="{{ asset('/assets/user-front/images/email_logo.jpeg') }}" width="220px"
                        height="58px" />
                </div>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:0;">
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue">
                                    <strong>{{ Helper::uppercase($assistantenquiry->unique_id) }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Name</div>
                                <div class="textvalue"><strong>{{ $assistantenquiry->name }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Email</div>
                                <div class="textvalue"><strong>{{ $assistantenquiry->email }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Mobile</div>
                                <div class="textvalue"><strong>{{ $assistantenquiry->mobile }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Booking Date</div>
                                <div class="textvalue"><strong>{{ $assistantenquiry->booking_date }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">No Of Days</div>
                                <div class="textvalue"><strong>{{ $assistantenquiry->no_of_days }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Hotel Name</div>
                                <div class="textvalue"><strong>{{ $assistantenquiry->hotel_name }}</strong></div>
                            </td>
                        </tr>
                    </table>
                </div>
