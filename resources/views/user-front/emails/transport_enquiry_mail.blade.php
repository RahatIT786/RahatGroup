        ...
        <div class="email-container">
            <div style="padding: 20px;">
                <div
                    style="text-align: center;
                               background-color: #ababab;margin-bottom:20px;">
                ...
                <div class="mailheader">
                    ...
                    <p style="margin:0px;color:#206099;font-size:16px;">We have received Inquiry for Transport</p>
                </div>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:0;">
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue">
                                    <strong>{{ Helper::uppercase($transportEnquiry->unique_id) }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Full Name</div>
                                <div class="textvalue"><strong>{{ $transportEnquiry->name }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Sector</div>
                                <div class="textvalue"><strong>{{ $sector_name }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Pickup From </div>
                                <div class="textvalue"><strong>{{ $transportEnquiry->pickup_from }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Pickup Date</div>
                                <div class="textvalue">
                                    <strong>{{ $transportEnquiry->pickup_date ? Helper::formatCarbonDate($transportEnquiry->pickup_date) : '' }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Pickup Time</div>
                                <div class="textvalue">
                                    <strong>{{ $transportEnquiry->pickup_time ? \Carbon\Carbon::parse($transportEnquiry->pickup_time)->format('h:i A') : '' }}</strong>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Mobile No (Home)</div>
                                <div class="textvalue"><strong>{{ $transportEnquiry->mobile_home }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Mobile No (Saudi)</div>
                                <div class="textvalue"><strong>{{ $transportEnquiry->mobile_saudi }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Whatsapp No</div>
                                <div class="textvalue"><strong>{{ $transportEnquiry->whatsapp_num }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Email Id</div>
                                <div class="textvalue"><strong>{{ $transportEnquiry->email }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Nationality</div>
                                <div class="textvalue"><strong>{{ $transportEnquiry->nationality }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Address</div>
                                <div class="textvalue"><strong>{{ $transportEnquiry->address }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Description</div>
                                <div class="textvalue"><strong>{{ $transportEnquiry->description }}</strong></div>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="footer">
                <table style="background: #333333;width:100%;color:#ffffff;">
                    <tr>
                        <td colspan='2' style="text-align: center; padding-top:20px;">Need More help? We are Here ,
                            Ready
                            to
                            Talk.</td>
                    </tr>
                    <tr>
                        <td style="text-align: right;width:50%;padding-right:20px;">
                            ...
                            <p class="footer-link"><strong>Email :</strong> <a href="{{ $adminSetting }}"
                                    style="color: #ffffff">{{ $adminSetting }}</a></p>
                        </td>
                        <td style="width:50%;">
