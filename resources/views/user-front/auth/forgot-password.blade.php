            ...
            <div class="containerbox">
                ...
                <div class="sign_in form_container">
                    <form class="login100-form validate-form" method="POST"
                        action="{{ route('customer.ForgotPasswordPost') }}">
                ...
                <div class="toggle_container">
                    <div class="toggle">
                        ...
                        <div class="toggle_panel toggle_right">
                            ...
                            <a href="{{ route('customer.login') }}" class="hidden btn default-btn" id="register">SIGN UP</a>
                            <p class="forgetpass"><a href="{{ route('customer.login') }}" style="color: white; font-weight: bold;"><strong> Already have an account? Log In</strong></a></p>
                        </div>
                    </div>
                </div>
            </div>
