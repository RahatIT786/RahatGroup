                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h4 class="display-5">{{ __('tablevars.forex_enquiry') }}</h4>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <li class="nav-item list-unstyled dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                                                        ...
                                                        <a class="dropdown-item py-2" href="javascript:void(0)"
                                                            data-toggle="modal"
                                                            wire:click="getModalContent({{ $forexenquiry->id }})"
                                                        ...
                                                        <a class="dropdown-item py-2" href="javascript:void(0)"
                                                            data-toggle="modal"
                                                            wire:click="changestatus({{ $forexenquiry->id }})"
                                                            data-target="#editModal"><i
                                                                class="mdi mdi-check text-primary"></i>Change Status</a>


                                                        {{-- @if ($forexenquiry->status == 1)
                                                            <a class="dropdown-item py-2" href="javascript:void(0)"
                                                                wire:click="completed({{ $forexenquiry->id }})">
                                                                <i class="mdi mdi-check text-primary"></i>
                                                                Complete</a>

                                                            <a class="dropdown-item py-2" href="javascript:void(0)"
                                                                wire:click="rejected({{ $forexenquiry->id }})">
