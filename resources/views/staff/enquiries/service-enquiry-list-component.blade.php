                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        ...
                                        wire:keyup="filterServiceEnquiry">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h4 class="display-5">{{ __('tablevars.service_enquiry') }}</h4>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <li class="nav-item list-unstyled dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                                                        ...
                                                        <a class="dropdown-item py-2" href="javascript:void(0)"
                                                            data-toggle="modal"
                                                            wire:click="getModalContent({{ $serviceEnquiry->id }})"
                                                            data-target="#enquiryListModal"><i
                                                                class="mdi mdi-check text-primary"></i> View</a>

                                                        <a class="dropdown-item py-2" href="javascript:void(0)"
                                                            data-toggle="modal"
                                                            wire:click="changestatus({{ $serviceEnquiry->id }})"
                                ...
                                @if ($modalData)
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($modalData->booking_date)->format('d-M-Y') }}
                                            </td>
                                        </tr>
                                        <tr>
