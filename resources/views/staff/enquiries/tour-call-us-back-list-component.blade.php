                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h4 class="display-5">{{ __('tablevars.tour_call_usback') }}</h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                                ...
                                                <li class="nav-item list-unstyled dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                                                        ...
                                                        <a class="dropdown-item py-2" href="javascript:void(0)"
                                                            data-toggle="modal"
                                                            wire:click="getModalContent({{ $tourcallusback->id }})"
                                                            data-target="#enquiryListModal"><i
                                                                class="mdi mdi-check text-primary"></i> View</a>

                                                        <a class="dropdown-item py-2" href="javascript:void(0)"
                                                            data-toggle="modal"
                                                            wire:click="changestatus({{ $tourcallusback->id }})"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="enquiryListModalTitle">Tour Call Us Back</h5>
                                ...
                                @if ($modalData)
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($modalData->travel_date)->format('d-M-Y') }}
                                            </td>
                                        </tr>
                                        <tr>
