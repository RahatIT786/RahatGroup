                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div cclass="form-group">
                                    <label class="label-header" for="serviceType">
                                        {{ __('tablevars.service_type') }}</label>
                                    <input type="text" name="serviceType" id="serviceType" class="form-control"
                                        wire:model='serviceType' placeholder="Search Service Type" autocomplete="off"
                                        wire:keyup="filterManageEnquiry">
                                </div>
                            </div>
                            <div class="col-md-3">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h4 class="display-5">{{ __('tablevars.manage-enquiry') }}</h4>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <li class="nav-item list-unstyled dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                                                        ...
                                                        <a class="dropdown-item py-2" href="javascript:void(0)"
                                                            data-toggle="modal"
                                                            wire:click="getModalContent({{ $manageEnquiry->id }})"
                                                            data-target="#enquiryListModal"><i
                                                                class="mdi mdi-check text-primary"></i> View</a>

                                                        <a class="dropdown-item py-2" href="javascript:void(0)"
                                                            data-toggle="modal"
                                                            wire:click="changestatus({{ $manageEnquiry->id }})"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="enquiryListModalTitle">Manage Enquiry Details</h5>
