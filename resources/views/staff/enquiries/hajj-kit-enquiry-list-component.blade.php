                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h4 class="display-5">{{ __('tablevars.umrah_hajjkit_enquiry') }}</h4>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <li class="nav-item list-unstyled dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                                                        ...
                                                        <a class="dropdown-item py-2" href="javascript:void(0)"
                                                            data-toggle="modal"
                                                            wire:click="getModalContent({{ $hajjkitEnquiry->id }})"
                                                            data-target="#enquiryListModal"><i
                                                                class="mdi mdi-check text-primary"></i> View</a>

                                                        <a class="dropdown-item py-2" href="javascript:void(0)"
                                                            data-toggle="modal"
                                                            wire:click="changestatus({{ $hajjkitEnquiry->id }})"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="enquiryListModalTitle">Umrah & Hajjkit Enquiry Details</h5>
                                ...
                                @if ($modalData)
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($modalData->delivery_date)->format('d-M-Y') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('tablevars.mobile_number') }} </th>
