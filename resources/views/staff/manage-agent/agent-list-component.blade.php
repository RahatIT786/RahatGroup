                            ...
                            @if ($modalData)
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ !empty($modalData->valid_upto) ? Helper::appDateFormat($modalData->valid_upto) : '-' }}
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($modalData->profile_img)
                                                <a href="{{ asset('storage/profile_image/' . $modalData->profile_img) }}"
                                                    download="{{ $modalData->profile_img }}" target="_blank"
                                                    download>
                                                    Download
                                                </a>
                                                <a href="{{ asset('storage/profile_image/' . $modalData->profile_img) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($modalData->company_logo)
                                                <a href="{{ asset('storage/company_logo/' . $modalData->company_logo) }}"
                                                    download="{{ $modalData->company_logo }}" target="_blank"
                                                    download>
                                                    Download
                                                </a>
                                                <a href="{{ asset('storage/company_logo/' . $modalData->company_logo) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($modalData->owners_passport)
                                                <a href="{{ asset('storage/owners_passport/' . $modalData->owners_passport) }}"
                                                    download="{{ $modalData->owners_passport }}" target="_blank"
                                                    download>
                                                    Download
                                                </a>
                                                <a href="{{ asset('storage/owners_passport/' . $modalData->owners_passport) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($modalData->owners_adhaar)
                                                <a href="{{ asset('storage/owners_adhaar/' . $modalData->owners_adhaar) }}"
                                                    download="{{ $modalData->owners_adhaar }}" target="_blank"
                                                    download>
                                                    Download
                                                </a>
                                                <a href="{{ asset('storage/owners_adhaar/' . $modalData->owners_adhaar) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($modalData->owners_pancard)
                                                <a href="{{ asset('storage/owners_pancard/' . $modalData->owners_pancard) }}"
                                                    download="{{ $modalData->owners_pancard }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($modalData->cancelled_cheque)
                                                <a href="{{ asset('storage/cancelled_cheque/' . $modalData->cancelled_cheque) }}"
                                                    download="{{ $modalData->cancelled_cheque }}"
                                                    class="btn btn-success">
                                                    Download
                                                </a>
                                                <a href="{{ asset('storage/cancelled_cheque/' . $modalData->cancelled_cheque) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($modalData->office_address_proof)
                                                <a href="{{ asset('storage/office_address_proof/' . $modalData->office_address_proof) }}"
                                                    download="{{ $modalData->office_address_proof }}"
                                                    class="btn btn-success">
                                                    Download
                                                </a>
                                                <a href="{{ asset('storage/office_address_proof/' . $modalData->office_address_proof) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($modalData->company_name_proof)
                                                <a href="{{ asset('storage/company_name_proof/' . $modalData->company_name_proof) }}"
                                                    download="{{ $modalData->company_name_proof }}"
                                                    class="btn btn-success">
                                                    Download
                                                </a>
                                                <a href="{{ asset('storage/company_name_proof/' . $modalData->company_name_proof) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($modalData->office_board)
                                                <a href="{{ asset('storage/office_board/' . $modalData->office_board) }}"
                                                    download="{{ $modalData->office_board }}"
                                                    class="btn btn-success">
                                                    Download
                                                </a>
                                                <a href="{{ asset('storage/office_board/' . $modalData->office_board) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($modalData->reception)
                                                <a href="{{ asset('storage/reception/' . $modalData->reception) }}"
                                                    download="{{ $modalData->reception }}" class="btn btn-success">
                                                    Download
                                                </a>
                                                <a href="{{ asset('storage/reception/' . $modalData->reception) }}"
                                                    target="_blank" class="btn btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($modalData->boss_cabin)
                                                <a href="{{ asset('storage/boss_cabin/' . $modalData->boss_cabin) }}"
                                                    download="{{ $modalData->boss_cabin }}" class="btn btn-success">
                                                    Download
                                                </a>
                                                <a href="{{ asset('storage/boss_cabin/' . $modalData->boss_cabin) }}"
                                                    target="_blank" class="btn btn-primary">
