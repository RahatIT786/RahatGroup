                                                ...
                                                <tbody>
                                                    @forelse ($ApprovedPayments as $key => $AllPayment)
                                                        <tr>
                                                            ...
                                                            <td>{{ number_format($AllPayment->amount, 2) }}</td>
                                                            {{-- <td>{{ $AllPayment->company }}</td> --}}
                                                            <td>{{ $AllPayment->txn_id }}</td>
                                                            <td>{{ Helper::appDateFormat($AllPayment->txn_date) }}</td>
                                                            <td>{{ $AllPayment->bank_name }}</td>
                                                            <td>
                                                                <div class="ticket-grp mb-2 has-submenu">
                                                                    <button class="btn btn-primary ticket-btn-grp btn-sm dropdown-toggle"
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <select name="per_page" id="per_page" wire:model='perPage'
                                                    class="form-control"
                                                    wire:change='filterPayments'>                                                    @foreach (Helper::getPerPageOptions() as $item)
