                                ...
                                <div class="settings-menu p-0">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-4 mb-4">
                                                <div class="form-group">
                                                    <label class="form-control-label">Custom Amount
                                                    </label>
                                                    <input type="text" class="form-control" placeholder="Enter Custom Amount" wire:model="custom_amount" wire:change="changes" min="1"  max="{{ $this->quote->tot_cost }}" oninput="this.value = Math.max(1, Math.min(this.value, {{ $this->quote->tot_cost }}))">
                                                </div>
                                            </div>
                                           @endif
