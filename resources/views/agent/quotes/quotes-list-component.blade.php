<div class="page-content">
    <div class="container-fluid">
        @if(session('booking_id') && session('txn_id'))
            <div class="alert alert-success alert-dismissible fade show text-center" role="alert">
                Transation Successful , Booking ID - <b>{{ session('booking_id') }}</b> with Transaction ID <b>{{ session('txn_id') }}</b>
                                ...
                                <div class="settings-inner-blk p-0">
                                    <div class="comman-space pb-0">
                                        <div
                                            ...
                                            <div>
                                                <a class="btn btn-primary" href="{{ route('agent.quotes.create') }}"
                                                                ...
                                                                <b>
                                                                    ...
                                                                    @if ($quote->service_type == 2)
                                                                        @if ($quote->umrah_type == 1)
                                                                            <span class="web-badge badge-info">FixedGroup Package</span></br>
                                                                        @else
                                                                            <span class="web-badge badge-info">Land Package</span></br>
                                                                        @endif
                                                                    @endif
                                                                    </span>
                                                            </td>
                                                            ...
                                                            <td style="width: 10%;">
                                                                <div class="ticket-grp mb-2 has-submenu">
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        @endif
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('agent.quotes.details', ['quote_id' => $quote->id]) }}"
                                                                            title="Make Payment">Make Payment</a>
                                                                        <div class="dropdown-divider"></div>
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('agent.quotes.edit', ['quote_id' => $quote->id]) }}"
                                                                            title="Edit">Edit</a>
                                    ...
                                    @if ($request_modal_data)
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-4">
                                                ...
                                                <div>
                                                    {{ $request_modal_data->agency ? $request_modal_data->agency->agency_name : '' }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-4">
                                                ...
                                                <div>{{ optional($request_modal_data->packagetype)->package_type ?? 'N/A' }}</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-4">
                                                ...
                                                <div>{{ optional($request_modal_data->sharingtype)->name ?: 'N/A' }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-4">
