                        ...
                        <div class="col-md-12">
                            <div class="settings-widget">
                                <div class="settings-inner-blk p-0">
                                    ...
                                    <div class="comman-space pb-0">
                                        <div class="mb-2">
                                            <a href="{{ route('agent.quotes.payment-confirmation', ['quote_id' => $quote->id]) }}"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-dark" title="Update" data-bs-dismiss="modal" wire:click='negotiatedAmount'>Update</button>
                    <button type="button" class="btn btn-dark" title="Close" data-bs-dismiss="modal">{{ __('tablevars.close') }}</button>
                </div>
            </div>
        </div>
    </div>
