        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xl-10 col-lg-9 col-md-12">
                            ...
                            <div class="single-travel-boxes">
                                <div id="desc-tabs" class="desc-tabs">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li role="presentation">
                                            <a href="{{ route('agent.travel-calendar.index') }}">
                                        ...
                                        <li role="presentation">
                                            {{-- <a href="{{ route('agent.profile.index') }}"  aria-controls="profile">
                    ...
                    @livewire('agent.components.status-box-component')
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Booking Quotes v/s Actual Bookings</h4>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <canvas id="myBarChart" height="347"></canvas>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Packages Bought By Service</h4>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <canvas id="myPlotChart" height="125"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
                    @livewire('agent.components.request-list-component')
