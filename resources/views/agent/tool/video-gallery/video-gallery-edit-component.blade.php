                            ...
                            <div class="settings-widget profile-details">
                                <div class="settings-menu p-0">
                                    <div class="profile-heading d-flex justify-content-between">
                                        <h3 class="m-0">Edit Video Gallery</h3>
                                    ...
                                    <div class="checkout-form personal-address add-course-info">
                                        <form wire:submit.prevent="update">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-block">
                                                        <label class="form-control-label">Event Date<span
                                                                class="text-danger">*</span></label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-block">
                                                        <label class="form-control-label">Upload Image<span
                                                                class="text-danger">*</span></label>
                                                    ...
                                                    @elseif (!empty($imageEdit))
                                                        <img src="{{ asset('storage/event_image/' . $imageEdit) }}"
                                                            style="height: 100px; border-radius: 10px; width: 160px;">
                                                    @else
