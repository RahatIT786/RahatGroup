                                ...
                                <div class="settings-inner-blk p-0">
                                    <div class="comman-space pb-0">
                                        <div
                                            ...
                                            <h4>Manage Image Gallery</h4>
                                            <div>
                                                <a class="btn btn-primary" href="{{ route('agent.imageGallery.create') }}">Add New</a>
                                            ...
                                            <div class="show-filter all-select-blk">
                                                <div class="row gx-2">
                                                    <div class="col-md-3 col-lg-3 col-item">
                                                        <label
                                                            class="form-control-label">{{ __('tablevars.event') }} {{ __('tablevars.name') }}</label>
