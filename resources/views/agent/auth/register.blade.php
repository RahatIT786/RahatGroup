    ...
    <div class="l-login-reg ">
        ...
        <div class="l-login-reg__form">
            <form class="c-login-form" method="post" novalidate="novalidate" name="form1" id="form1"
                autocomplete="off" action="{{ route('agent.postRegister') }}">
                ...
                <div class="form-group">
                    <input class="c-login-form__control" type="text" placeholder="Agency Name" name="agency_name"
                        id="agency_name" autocomplete="off" required="required" maxlength="100"
                        value="{{ old('agency_name') }}" autofocus="">
                    @error('agency_name')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    <input class="c-login-form__control" type="text" placeholder="Owner Name" name="owner_name"
                        id="owner_name" autocomplete="off" required="required" maxlength="100"
                ...
                <div class="form-group">
                    <select class="c-login-form__control" id="state_id" name="state_id" required="required"
                        value="{{ old('state_id') }}">
                        <option value="">{{ __('tablevars.select') }}
                            {{ __('tablevars.state') }}</option>
                        @foreach ($QsStates as $RsCity)
                            <option value="{{ $RsCity->id }}">{{ $RsCity->state_name }}
                            </option>
                        @endforeach
                    </select>
                    @error('state_id')
                ...
                <div class="form-group">
                    <input class="c-login-form__control" type="text" placeholder="City" name="city" id="city"
                        autocomplete="off" required="required" maxlength="12" value="{{ old('city') }}"
                        autofocus="">
                    @error('city')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="form-group">
                    <input class="c-login-form__control" type="text" placeholder="Mobile" name="mobile"
                        id="mobile" maxlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                        autocomplete="off" required="required" {{ old('mobile') }} autofocus="">
                    @error('mobile')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    <input class="c-login-form__control" type="email" placeholder="Email" name="email"
                        id="email" autocomplete="off" maxlength="100" required="required" {{ old('email') }}
                        autofocus="">
                ...
                <div class="w-100 button-actions">
