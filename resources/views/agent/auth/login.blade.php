...
<body style="background-image: url({{ asset('img/login-bg.jpeg') }}) !important;">
    <div class="l-login-reg">
        ...
        <div class="l-login-reg__form">
            <form class="c-login-form" method="POST" novalidate="novalidate" name="form1" id="form1" autocomplete="off" action="{{ route('agent.postLogin') }}">
                @csrf
                @method('post')
                ...
                @endif
                <h1 class="c-login-form__title"></h1>

                <div class="form-group">
                    <input class="c-login-form__control" type="text" name="email" placeholder="Email ID" id="email" autocomplete="off" maxlength="40" required="required" autofocus="">
                    @error('email')
                ...
                <div class="form-group">
                    ...
                    <input class="c-login-form__control" type="password" placeholder="Password" name="password" id="password" maxlength="40" autocomplete="off" required="required" style="padding-right:26px;"/>
                    <a href="javascript:void(0);" class="show-pass" style="position:absolute;right:10px;top:50%;transform:translateY(-50%);line-height: 1;"><i class="fa fa-eye fa-lg"></i></a>
                    </div>
                    @error('password')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <button id="kt_login_signin_submit" class="c-login-form__login-btn" onclick="$('#form1').submit()">
                    <span >
                        Sign In
                        <svg class="c-login-form__login-btn__icon" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512; " xml:space="preserve"> <path d="M506.134,241.843c-0.006-0.006-0.011-0.013-0.018-0.019l-104.504-104c-7.829-7.791-20.492-7.762-28.285,0.068    c-7.792,7.829-7.762,20.492,0.067,28.284L443.558,236H20c-11.046,0-20,8.954-20,20c0,11.046,8.954,20,20,20h423.557    l-70.162,69.824c-7.829,7.792-7.859,20.455-0.067,28.284c7.793,7.831,20.457,7.858,28.285,0.068l104.504-104    c0.006-0.006,0.011-0.013,0.018-0.019C513.968,262.339,513.943,249.635,506.134,241.843z"></path></svg>
                    </span>
                </button>

                <div class="w-100 button-actions mt-3">
                    <a href="{{ route('agent.forgotPassword') }}" class="float-right kt-login__link-forgot">
                        Forgot Password
                    </a>

                    <a href="{{ route('agent.register') }}" class="float-right kt-login__link-forgot">
                        Create your Account
                    </a>
                </div>
            </form>
        ...
        $(document).ready(function(){
            $('.show-pass').click(function(){
                ...
                if(type == 'text'){
                    ...
                    $(this).find('i').attr('class', 'fa fa-eye fa-lg');
                }
                if(type == 'password'){
                    $(this).prev().attr('type', 'text');
                    $(this).find('i').attr('class', 'fa fa-eye-slash fa-lg');
                }
            });
        });
    </script>
