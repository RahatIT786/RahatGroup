<div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xl-10 col-lg-9 col-md-12">
                    <section class="breadcrumbg">
                        <div class="container">
                            <div aria-label="breadcrumb">
                                @if ($packages)
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="https://www.rahatumrah.in/">Home</a></li>
                                        <li class="breadcrumb-item"><a href="{{ route('agent.packageDetails.index') }}"
                                                id="MainContent_lnkPackageList">Package List</a></li>
                                        <li id="MainContent_liActiveLink" class="breadcrumb-item active"
                                            aria-current="page">{{ $packages->name }}</li>
                                    </ul>
                                @endif
                            </div>
                        </div>
                    ...
                    <section class="packagehighgalarea">
                        <div class="container">
                            <div class="row">
                                        ...
                                        <div class="packageModal-gallery">
                                            <div id="carouselExampleIndicators" class="carousel slide">
                                                <div class="carousel-inner">
                                                    @if (!empty($packages->pkgImages) && count($packages->pkgImages) > 0)
                                                        @foreach ($packages->pkgImages as $index => $pkg_imgs)
                                                            <div
                                                                class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                                                <a href="#">
                                                                    <img src="{{ asset('storage/package_image/' . $pkg_imgs->pkg_img) }}"
                                                                        alt="Package Image" title=""
                                                                        border="0">
                                                                </a>
                                                            </div>
                                                        @endforeach
                                ...
                                @endif
                                <div class="col-md-5">
                                    <h2 id="MainContent_h2TourNam">Booking Enquiry</h2>
                                    <hr />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="mb-3">
                                                            <div class="genformlabel">
                                                                <label
                                                                    class="form-control-label">{{ __('tablevars.departure_city') }}
                                                                    <span class="text-red">*</span></label>
                                                            </div>
                                                            <select class="form-control" wire:model='city_id'
                                                                wire:change="selectCity" id="city_id">
                                                                <option value="">{{ __('tablevars.city') }}
                                                                    {{ __('tablevars.name') }}
                                                                </option>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="mb-3">
                                                            <div class="genformlabel">
                                                                ...
                                                                @else
                                                                    <select class="form-control" wire:model='travel_date' wire:change="selectDate"
                                                                        id="travel_date">
                                                                        <option value="">Select Dates
                                                                        </option>
                                                                        @foreach ($dept_dates as $key => $date)
                                                    ...
                                                    <div id="MainContent_dvPackageCategory" class="col-sm-6">
                                                        <div class="mb-3">
                                                            <div class="genformlabel">
                                                                <label
                                                                    class="form-control-label">{{ __('tablevars.airlines') }}
                                                                    <span class="text-red">*</span></label>
                                                            </div>
                                                            <select class="form-control" wire:model='airline_id'
                                                                wire:change=" {{  count($pnr) == 0 ? 'putInData' : 'selectFlight'}}" id="airline_id">
                                                    ...
                                                    <div id="MainContent_dvPackageCategory" class="col-sm-6">
                                                        <div class="mb-3">
                                                            <div class="genformlabel">
                                                                <label
                                                                    class="form-control-label">{{ __('tablevars.pkg_type') }}
                                                                    <span class="text-red">*</span>
                                                                </label>
                                                            </div>
                                                            <select class="form-control" name="package_type"
                                                                wire:change="changeFlavour"
                                                ...
                                                <div class="row gx-3">
                                                    <div class="col-4">
                                                        <strong>
                                                            <div id="MainContent_divCost" class="price">
                                                                ₹{{ number_format($g_share, 2) }}</div>
                                                        </strong>
                                                        <div style="font-weight: bold" class="pricefromtext">per
                                                            person</div>
                                                    </div>
                                                    @if(count($pnr) > 0)
                                                    <div class="col-3">
                                                        <strong>
                                                            <div id="MainContent_divAvailableSeat" class="price">{{$avail_seats}}
                                                            </div>
                                                        </strong>
                                                        <div style="font-weight: bold" class="pricefromtext">
                                                            Seats</div>
                                                    </div>
                                                    @endif
                                                    <div class="col-5 text-end">
                                                        <button type="button" data-bs-toggle="modal"
                                                            data-bs-target="#packageModal" title="Book Now"
                                                            class="primarybtnborder"
                                                            id="btnEnquire">{{ __('tablevars.enquire') }}</button>
                                ...
                                <a class="downloaditnerybtn" href="{{ route('downloadHajjPackage', $packages->id) }}" type="button" id="lnkDownloadItinerary">{{ 'Download Itinerary' }} <i class="fa fa-download"></i></a>
                            </div> --}}
                                            ...
                                            <div style="margin-top: 40px">
                                                ...
                                                <div style="margin-top: 10px; color: green;">
                                                    ...
                                                    <a href="javascript:void(0)" id="read-less-{{ $id }}"
                                                        style="display:none;"
                                                        onclick="toggleText('{{ $id }}')">Read Less</a>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="tabs">
                                    ...
                                    <nav role="navigation" class="transformer-tabs">
                                        <div class="container">
                                            <ul class="nav nav-tabs" id="nav-tab" role="tablist">
                                                <li><a href="#Hotels" class="active" id="lnkHotels"
                                                        data-bs-toggle="tab" role="tab"
                                                        aria-selected="true">Hotels</a></li>
                                                <li><a href="#TourCost" id="lnkTourCost" data-bs-toggle="tab"
                                                        role="tab" aria-selected="false">Tour Cost</a></li>

                                                <li><a href="#PackageOverview" data-bs-toggle="tab" role="tab"
                                                        aria-selected="false" id="lnkPackageOverview">Package
                                                        Overview</a></li>
                                                <li><a href="#InclusionsExclusions" id="lnkInclusionsExclusions"
                                                        data-bs-toggle="tab" role="tab"
                                                        aria-selected="false">Inclusions / Exclusions</a></li>

                                                <li><a href="#Itinerary" id="lnkItinerary" data-bs-toggle="tab"
                                                        role="tab" aria-selected="false">Itinerary</a></li>
                                                <li><a href="#PaymentPolicy" id="lnkPaymentPolicy"
                                                        data-bs-toggle="tab" role="tab"
                                                        aria-selected="false">Payment Policy / Important Notes</a></li>
                                                <li><a href="#CancellationPolicy" id="lnkCancellationPolicy"
                                                        data-bs-toggle="tab" role="tab"
                                                        aria-selected="false">Cancellation Policy</a></li>
                                            </ul>
                                        </div>
                                    </nav>
                                    <!--Tab Name end here-->
                                    ...
                                    <div class="tab-content tabcont" id="nav-tabContent">
                                                                    ...
                                                                    <div class="peoplesharebox">
                                                                        <div class="peopleshareicon"><svg
                                                                                ...
                                                                                <path
                                                                                    ...
                                                                                    transform="translate(-43.5 -10.55)">
                                                                                </path>
                                                                                <path
                                                            ...
                                                            @if ($child_with_bed !== 0)
                                                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-6">
                                                                    <div class="peoplesharebox">
                                                                        ...
                                                                        <div class="peoplesharetext">Child with Bed
                                                                        </div>
                                                                        <div class="pricesmall">INR
                                                                            {{ number_format($child_with_bed, 2) }}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            @if ($child_no_bed !== 0)
                                                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-6">
                                                                    <div class="peoplesharebox">
                                                                        ...
                                                                        <div class="peoplesharetext">Child without Bed
                                                                        </div>
                                                                        <div class="pricesmall">INR
                                        ...
                                        <div id="Itinerary" class="tab-pane fade ">
                                            <div id="divItinerary" class="mainheading">
                                                <h4>Itinerary</h4>
                                                {!! $packages->itinerary !!}
                                            </div>
                                        </div>
                                        ...
                                        <!--Client Speak tab content start-->
                                        <div id="ClientSpeak" class="tab-pane fade">
                                            <div class="container">
                                                <div class="testimonialsarea">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <div class="testimonialsvideobg">
                                                                <img src="img/dummy/packagegallery01.jpg">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-8 rowmargin30">
                                                            <h4>Hamid Khan</h4>
                                                            <div class="infotxt">I would like to take this opportunity
                                                                to thank you for
                                                                the
                                                                excellent service and co-operation I received from your
                                                                colleagues in
                                                                Jeddah,
                                                                Madinah and Mecca. They were quite efficient and the
                                                                required transport
                                                                was
                                                                available punctually at all the places and we were
    ...
    @livewire(
        'agent.packages.package-details.package-view-modal-component',
        [
            'id' => $packageId,
            'travel_date' => $travel_date,
            'city' => $city_id,
            'airline_id' => $airline_id,
            'selectedPackageFlavourId' => $selectedPackageFlavourId,
        ],
        key($packageId . $travel_date . $city_id . $airline_id)
    )
    {{-- </div> --}}
</div>
...
@push('extra_css')
    <style>
        ...
        .breadcrumb-item+.breadcrumb-item::before {
            ...
            color: #12086e;
            content: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="6.96" height="12.05" viewBox="0 0 6.96 12.05"><path id="arrow" d="M0,5.753,5.419,0l5.218,5.753" transform="translate(6.46 0.707) rotate(90)" fill="none" stroke="%2310069f" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"/></svg>');
            font-size: 15px;
            line-height: 15px;
        ...
        .packagedetpricebox .form-select {
        ...
        .itinerarycontarea {
            ...
            padding: 20px;
            border-radius: 20px;
            border: dashed 2px #ffd2d0;
            padding-bottom: 30px;
            box-shadow: 0px 4px 15px rgba(246, 111, 104, 0.2);
            transition: all ease-in 0.4s;
        }

        .itinerarycontarea:hover {
            box-shadow: 0px 4px 20px rgba(246, 111, 104, 0.8);
        }
        ...
        .day_location {
            ...
            box-shadow: 0px 4px 0px rgb(246, 111, 105);
        }
