                            ...
                            <div class="settings-widget profile-details">
                                <div class="settings-menu p-0">
                                    <div class="filter-grp ticket-grp d-flex justify-content-between profile-heading">
                                        ...
                                        <h3 class="m-0">{{ __('tablevars.edit_content') }}</h3>
                                        <div>
                                            <a class="btn btn-primary"
                                                href="{{ route('agent.content.index') }}"data-toggle="tooltip"
                                                title="Back">Back</a>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="input-block">
                                                        ...
                                                        <select class="form-control" wire:model='page_id' id="page_id"
                                                            ...
                                                            @foreach ($pagecontent as $id => $name)
                                                                <option value="{{ $id }}"
                                                                    @if ($page_id == $id) selected @endif>
                                                                    {{ $name }}</option>
                                                            @endforeach
                                                        </select>
                                                        <span class="text-danger" id="page_idError"
                                                            style="display: none;">Page name is required.</span>
                                                        @error('page_id')
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="input-block" wire:ignore>
                                                        ...
                                                        <div id="descriptionError" class="text-danger"
                                                            style="display: none;">Page content is required.</div>
                                                        @error('description')
