                                                ...
                                                <div class="row gx-2">
                                                    <div class="col-md-3 col-lg-3 col-item">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            wire:model='search_title' placeholder="Search Agency Code"
                                                            wire:keyup.debounce.500ms="filterBookings">
                                                    </div>
                                                    <div class="col-md-3 col-lg-3 col-item">
                                                        <label class="form-control-label">Agency</label>
                                                        <input type="text" class="form-control"
                                                            wire:model='search_title' placeholder="Search Agency"
                                                            wire:keyup.debounce.500ms="filterBookings">
                                                    </div>
                                                    <div class="col-md-3 col-lg-3 col-item">
                                                        <label class="form-control-label">Sub Agent</label>
                                                        <input type="text" class="form-control"
                                                            wire:model='search_title' placeholder="Search Sub Agent Name"
                                                            wire:keyup.debounce.500ms="filterBookings">
                                                    </div>
                                                </div>
                                            </div>
