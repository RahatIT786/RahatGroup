                                ...
                                <div class="settings-inner-blk p-0">
                                    <div class="comman-space pb-0">
                                        <div
                                            ...
                                            <div>
                                                <a class="btn btn-primary" href="{{ route('agent.content.create') }}">Add New</a>
                                            </div>
                                        </div>
                                            ...
                                            <table class="table table-nowrap mb-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>{{ __('tablevars.page') }} {{ __('tablevars.content') }}</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>1</td>
                                                        <td>Facebook</td>
                                                        <td>https://www.facebook.com/AIHUTPL/</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>2</td>
                                                        <td>Twitter</td>
                                                        <td>https://twitter.com/i/flow/login?redirect_after_login=%2Fal_mehfooz</td>
                                                        <td>
                                                            <div class="ticket-grp mb-2 has-submenu">
                                                                <button
                                                                    class="btn btn-primary ticket-btn-grp btn-sm dropdown-toggle"
                                                    ...
                                                    <tr>
                                                        <td>3</td>
                                                        <td>Instagram</td>
                                                        <td>https://www.instagram.com/aihut.in/</td>
                                                        <td>
                                                            <div class="ticket-grp mb-2 has-submenu">
                                                                <button
                                                                    class="btn btn-primary ticket-btn-grp btn-sm dropdown-toggle"
