                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 mb-4">
                                                <div class="form-group">
                                                    ...
                                                    @if ($header_image && Helper::fileExists("flyers/$header_image"))
                                                        <a href="{{ asset("storage/flyers/$header_image") }}"
                                                            target="_blank">
                                                            <img src="{{ asset("storage/flyers/$header_image") }}"
                                            ...
                                            <div class="col-6 mb-4">
                                                <div class="form-group">
                                                    ...
                                                    @if ($footer_image && Helper::fileExists("flyers/$footer_image"))
                                                        <a href="{{ asset("storage/flyers/$footer_image") }}"
                                                            target="_blank">
                                                            <img src="{{ asset("storage/flyers/$footer_image") }}"
                                                                class="img-fluid shadow-light rounded mt-2"
                                                                style="width: 50px;">
                                                        </a>
                                                    @endif
