                                    ...
                                    <div class="comman-space pb-0">
                                        <div class="settings-referral-blk course-instruct-blk table-responsive">
                                            <table class="table table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    @forelse ($Icards as $key => $Icard)
                                                        <tr>
                                                            <td>{{ $key + $Icards->firstItem() }}</td>
                                                            <td>{{ $Icard->booking_id }}</td>
                                                            <td>{{ $Icard->adult + $Icard->child + $Icard->child_bed + $Icard->infant }}
                                                            </td>
                                                            <td>
                                                                <div class="ticket-grp mb-2 has-submenu">
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                            wire:click="downloadICard('{{ $Icard->id }}')"
                                        ...
                                        <div
                                            ...
                                            {{ $Icards->links(data: ['scrollTo' => false]) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
