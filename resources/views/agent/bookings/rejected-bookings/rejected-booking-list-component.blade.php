                                ...
                                <div class="settings-inner-blk p-0">
                                    <div class="comman-space pb-0">
                                        <div
                                            ...
                                            <h3>{{ __('tablevars.rejected_booking_list') }}</h3>
                                    ...
                                    <div class="comman-space pb-0">
                                        <div class="settings-referral-blk course-instruct-blk table-responsive">
                                            <table class="table table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    @forelse ($rejectedbookings as $key => $rejectedbooking)
                                                        @php
                                                            $payments = $rejectedbooking->payment;
                                                            $TotalPayment = 0;
                                                        ...
                                                        @endphp
                                                        <tr>
                                                            <td>{{ $key + $rejectedbookings->firstItem() }}</td>
                                                            <td>{{ $rejectedbooking->booking_id }}</td>
                                                            <td>{{ $rejectedbooking->servicetype->name }}</td>
                                                            <td>{{ $rejectedbooking->mehram_name }}</td>
                                                            <td>{{ $rejectedbooking->travel_date ? Helper::appDateFormat($rejectedbooking->travel_date) : 'N/A' }}
                                                            </td>
                                                            <td>{{ $rejectedbooking->adult }}</td>
                                                            <td>{{ number_format($rejectedbooking->tot_cost) }}</td>
                                                            <td>{{ number_format($rejectedbooking->tot_cost - $TotalPayment) }}
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                @endphp
                                                                @if (array_key_exists($rejectedbooking->booking_status, $statusLabels))
                                                                    <div
                                                                        class="pointer badge {{ $statusLabels[$rejectedbooking->booking_status]['class'] }}">
                                                                        {{ $statusLabels[$rejectedbooking->booking_status]['label'] }}
                                                                    </div>
                                                                @endif
                                                            </td>
                                                                ...
                                                                <div class="ticket-grp mb-2 has-submenu">
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <a href="javascript:void(0)"
                                                                            ...
                                                                            wire:click="getBookingContent({{ $rejectedbooking->id }})">View</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                        ...
                                        <div
                                            ...
                                            {{ $rejectedbookings->links(data: ['scrollTo' => false]) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
