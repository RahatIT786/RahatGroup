                                ...
                                <div class="settings-inner-blk p-0">
                                    <div class="comman-space pb-0">
                                        <div
                                            ...
                                            <h3>{{ __('tablevars.cancelled_booking_list') }}</h3>
                                            <div>
                                                ...
                                                <a href="javascript:void(0);" style="color: white"
                                                    class="btn btn-warning" wire:click="downloadBooking"><i
                                                        class="fas fa-file-excel" title="Print"></i>
                                    ...
                                    <div class="comman-space pb-0">
                                        <div class="settings-referral-blk course-instruct-blk table-responsive">
                                            <table class="table table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    @forelse ($cancelledbookings as $key => $cancelledbooking)
                                                        @php
                                                            $payments = $cancelledbooking->payment;
                                                            $TotalPayment = 0;
                                                        ...
                                                        <tr>
                                                            <td>{{ $key + $cancelledbookings->firstItem() }}</td>
                                                            <td>{{ $cancelledbooking->booking_id }}</td>
                                                            <td>{{ $cancelledbooking->servicetype->name }}</td>
                                                            <td>{{ $cancelledbooking->mehram_name }}</td>
                                                            <td>{{ $cancelledbooking->travel_date ? Helper::appDateFormat($cancelledbooking->travel_date) : 'N/A' }}
                                                            </td>
                                                            <td>{{ $cancelledbooking->adult }}</td>
                                                            <td>{{ number_format($cancelledbooking->tot_cost) }}</td>
                                                            <td>{{ number_format($cancelledbooking->tot_cost - $TotalPayment) }}
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                @endphp
                                                                @if (array_key_exists($cancelledbooking->booking_status, $statusLabels))
                                                                    <div
                                                                        class="pointer badge {{ $statusLabels[$cancelledbooking->booking_status]['class'] }}">
                                                                        {{ $statusLabels[$cancelledbooking->booking_status]['label'] }}
                                                                    </div>
                                                                @endif
                                                            </td>
                                                                ...
                                                                <div class="ticket-grp mb-2 has-submenu">
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <a href="javascript:void(0)"
                                                                            ...
                                                                            wire:click="getBookingContent({{ $cancelledbooking->id }})">View</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                        ...
                                        <div
                                            ...
                                            {{ $cancelledbookings->links(data: ['scrollTo' => false]) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
