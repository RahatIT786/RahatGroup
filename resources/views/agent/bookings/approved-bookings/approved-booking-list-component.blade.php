                                ...
                                <div class="settings-inner-blk p-0">
                                    <div class="comman-space pb-0">
                                        <div
                                            ...
                                            <h3>{{ __('tablevars.approved_booking_list') }}</h3>
                                            <div>
                                                ...
                                                <a href="javascript:void(0);" style="color: white"
                                                    class="btn btn-warning" wire:click="downloadApproved"><i
                                                ...
                                                <tbody>
                                                    @forelse ($approvedbookings as $key => $booking)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $booking->travel_date ? Helper::appDateFormat($booking->travel_date) : 'N/A' }}
                                                            </td>
                                                            <td>{{ $booking->adult }}</td>
                                                            <td>{{ number_format($booking->tot_cost) }}</td>
                                                            <td>{{ number_format($booking->tot_cost - $TotalPayment) }}
                                                            </td>
                                                            <td>
                                                                @php
                                                                    $statusLabels = [
                                                            ...
                                                            <td>
                                                                ...
                                                                href="{{ route('agent.bookings.add.pax', ['booking_id' => $booking->id]) }}">Add
                                                                Guest
                                                                Details</a>
                                                                        ...
                                                                        <a href="javascript:void(0)"
                                                                            ...
                                                                            wire:click="getBookingContent({{ $booking->id }})">View</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
