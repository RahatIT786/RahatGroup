                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control form-select select" wire:change="packageDetialsChange"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <label>{{ __('tablevars.departure_city') }} <span
                                                                class="text-danger">*</span></label>
                                                        <select class="form-control form-select select" wire:model="city_id"
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <label>{{ __('tablevars.departure_month') }} <span
                                                                class="text-danger">*</span></label>
                                                        <select class="form-control form-select select" wire:model="month_id"
                                                ...
                                                <div class="col-6 mb-4">
                                                    <div class="form-group">
                                                        <label>{{ __('tablevars.pkg_pnr') }} <span
                                                                class="text-danger">*</span></label>
                                                        <select class="form-control form-select select" wire:model='pnr_id'
                                                    ...
                                                    <div class="form-group">
                                                        <label>{{ __('tablevars.package') }}
                                                            {{ __('tablevars.name') }} <span
                                                                class="text-danger">*</span></label>
                                                        <select class="form-control form-select select" wire:model='pkg_name_id'
                                                    ...
                                                    <div class="form-group">
                                                        <label>{{ __('tablevars.package') }}
                                                            {{ __('tablevars.type') }}<span
                                                                class="text-danger">*</span></label>
                                                        <select class="form-control form-select select" name="pkg_type_id"
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <label>{{ __('tablevars.sharing') }}
                                                            {{ __('tablevars.type') }} <span
                                                                class="text-danger">*</span></label>
                                                        <select class="form-control form-select select" name="sharing_type"
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <label>{{ __('tablevars.country') }} <span
                                                                class="text-danger">*</span></label>
                                                        <select class="form-control form-select select" wire:model='country_id'
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <label>{{ __('tablevars.visa') }} <span
                                                                class="text-danger">*</span></label>
                                                        <select class="form-control form-select select" name="visa_type_id"
                                            ...
                                            @elseif($service_type_id == 13)
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <label>{{ __('tablevars.hotel') }}
                                                            {{ __('tablevars.name') }}<span
                                                                class="text-danger">*</span></label>
                                                        <select class="form-control form-select select" wire:model='hotel_id'
                                                ...
                                                {{-- Others --}}
                                            @else
                                            <div class="checkout-form personal-address add-course-info col-3">
                                                <div class="form-group">
                                                    <label>{{ __('tablevars.departure_city') }} <span
                                                            class="text-danger">*</span></label>
                                                    <select class="form-control form-select select" name="city_id"
                                                        wire:model="city_id">
                                                        <option value="">{{ __('tablevars.select') }}
                                                            {{ __('tablevars.departure_city') }}</option>
                                                        @foreach ($cities as $city)
                                            ...
                                            <div class="checkout-form personal-address add-course-info col-3">
                                                <div class="form-group">
                                                    <label>{{ __('tablevars.package') }}
                                                        {{ __('tablevars.type') }}<span
                                                            class="text-danger">*</span></label>
                                                    <select class="form-control form-select select" name="pkg_type_ids"
                                            ...
                                            <div class="checkout-form personal-address add-course-info col-3">
                                                <div class="form-group">
                                                    <label>{{ __('tablevars.sharing') }}
                                                        {{ __('tablevars.type') }} <span
                                                            class="text-danger">*</span></label>
                                                    <select class="form-control form-select select" name="sharing_type_id"
                                            ...
                                            <div class="checkout-form personal-address add-course-info col-9">
                                                <div class="form-group">
                                ...
                                <div class="card card-secondary">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="checkout-form personal-address add-course-info col-4 mb-4">
                                                <div class="form-group">
                                ...
                                <div class="card card-secondary">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="checkout-form personal-address add-course-info col-12 mb-4">
                                                <div class="form-group">
