                                ...
                                <div class="settings-inner-blk p-0">
                                    <div class="comman-space pb-0">
                                        <div
                                            ...
                                            <h3>{{ __('tablevars.negotiated_request') }} {{ __('tablevars.list') }}</h3>
                                            ...
                                            <div class="show-filter all-select-blk">
                                                <div class="row gx-2">
                                                    ...
                                                    <div class="col-md-3 col-lg-3 col-item mb-2">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Passenger Name" wire:model='' wire:keyup="">
                                                    </div>
                                                    <div class="col-md-3 col-lg-3 col-item mb-2">
                                                        <label
                                                ...
                                                <tbody>
                                                    @forelse ($quotes as $key => $quote)
                                                        <tr>
                                                            ...
                                                            <td style="width: 15%;">
                                                                <span><b>Negotiated Cost: </b></span></br>
                                                                <span>{{ Aihut::get('currency') }}
                                                                    {{ number_format($quote->negotiated_cost, 2) }}</span>
                                                            </td>
                                                            <td style="width: 15%;">
                                                                <span><b>Negotiation</b></span></br></br>
                                                                @if ($quote->negotiation_status == 1)
                                                                    <span
                                                                        class="web-badge badge-primary">Approved</span>
                                                                @elseif($quote->negotiation_status == 2)
                                                                    <span class="web-badge badge-danger">Rejected</span>
                                                                @endif
                                                            </td>
                                                            {{-- Action Column --}}
                                                            {{-- <td style="width: 10%;">
