                                ...
                                <div class="settings-inner-blk p-0">
                                    <div class="comman-space pb-0">
                                        <div
                                            ...
                                            <h3>{{ __('tablevars.deleted_booking_list') }}</h3>
                                    ...
                                    <div class="comman-space pb-0">
                                        <div class="settings-referral-blk course-instruct-blk table-responsive">
                                            <table class="table table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    @forelse ($deletedbookings as $key => $deletedbooking)
                                                        @php
                                                            $payments = $deletedbooking->payment;
                                                            $TotalPayment = 0;
                                                        ...
                                                        @endphp
                                                        <tr>
                                                            <td>{{ $key + $deletedbookings->firstItem() }}</td>
                                                            <td>{{ $deletedbooking->booking_id }}</td>
                                                            <td>{{ $deletedbooking->servicetype->name }}</td>
                                                            <td>{{ $deletedbooking->mehram_name }}</td>
                                                            <td>{{ $deletedbooking->travel_date ? Helper::appDateFormat($deletedbooking->travel_date) : 'N/A' }}
                                                            </td>
                                                            <td>{{ $deletedbooking->adult }}</td>
                                                            <td>{{ number_format($deletedbooking->tot_cost) }}</td>
                                                            <td>{{ number_format($deletedbooking->tot_cost - $TotalPayment) }}
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                @endphp
                                                                @if (array_key_exists($deletedbooking->booking_status, $statusLabels))
                                                                    <div
                                                                        class="pointer badge {{ $statusLabels[$deletedbooking->booking_status]['class'] }}">
                                                                        {{ $statusLabels[$deletedbooking->booking_status]['label'] }}
                                                                    </div>
                                                                @endif
                                                            </td>
                                                                ...
                                                                <div class="ticket-grp mb-2 has-submenu">
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <a href="javascript:void(0)"
                                                                            ...
                                                                            wire:click="getBookingContent({{ $deletedbooking->id }})">View</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                        ...
                                        <div
                                            ...
                                            {{ $deletedbookings->links(data: ['scrollTo' => false]) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
