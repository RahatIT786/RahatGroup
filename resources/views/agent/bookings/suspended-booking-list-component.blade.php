                                                ...
                                                <tbody>
                                                    {{-- @forelse ($bookings as $key => $booking) --}}
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {{-- @if ($booking->is_active) --}}
                                                                    <span class="badge badge-info info-low">Suspended</span>
                                                                {{-- @else --}}
                                                                    {{-- <span class="badge badge-info info-high">Inactive</span> --}}
                                                                {{-- @endif --}}
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {{-- @if ($booking->is_active) --}}
                                                                    {{-- <span class="badge badge-info info-low">Active</span> --}}
                                                                {{-- @else --}}
                                                                    <span class="badge badge-info info-low">Suspended</span>
                                                                {{-- @endif --}}
                                                            </td>
                                                    ...
                                                    {{-- <tr>
                                                        ...
                                                        <td>10-05-20</td>
                                                        <td><span class="badge badge-info info-low">Paid</span></td>
                                                        <td>$1200</td>
                                                        <td>Mastercard</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>10-05-20</td>
                                                        <td><span class="badge badge-info info-medium">Pending</span></td>
                                                        <td>$1100</td>
                                                        <td>Visa</td>
                                                        <td>
                                                            <a href="javascript:void(0);"><i
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>10-05-20</td>
                                                        <td><span class="badge badge-info info-high">Cancel</span></td>
                                                        <td>$1200</td>
                                                        <td>Visa</td>
                                                        <td>
                                                            <a href="javascript:void(0);"><i
