        ...
        <div class="email-container">
            ...
            background-color: #ababab;">
                ...
                <div class="header">
                    ...
                    <p style="margin:0px;color:#206099;font-size:16px;">We have received Inquiry for Booking</p>
                </div>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:0;">
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue">
                                    <strong>{{ Helper::uppercase($bookingData['request_id']) }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Passenger Name</div>
                                <div class="textvalue"><strong>{{ $bookingData['mehram_name'] }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Service Type</div>
                                <div class="textvalue"><strong>{{ $bookingData['service_type'] }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Contact Email</div>
                                <div class="textvalue"><strong>{{ $bookingData['email_id'] }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Total Cost</div>
                                <div class="textvalue"><strong>{{ number_format($bookingData['tot_cost'], 2) }}</strong>
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <div class="footer">
                ...
                <table style="background: #333333;width:100%;color:#ffffff;">
                    <tr>
                        <td colspan='2' style="text-align: center;">Need More help? We are Here , Ready to Talk.
                        </td>
                    </tr>
                    <tr>
