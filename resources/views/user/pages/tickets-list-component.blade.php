<div>
            ...
            <div class="container">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <select class="custom-select form-control"
                                                    wire:model.live="search_flight" wire:keyup="changeInput">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input class="form-control w-100" wire:model.live="search_dept_date"
                                                    placeholder="Departing Date" type="text"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input class="form-control w-100" wire:model.live="search_return_date"
                                                    placeholder="Return Date" type="text"
                                                    onfocus="(this.type='date')" onblur="(this.type='text')">
                                            </div>
                                        </div>
                ...
                <div class="row" id="ticket_list">
                    ...
                    {{-- <div class="col-md-12  mb-2">
                        <h4 class="box-title rounded-top" style="color: #494a6e;">
                            {{ $pnrs->count() }} PNR(s) Found
                        </h4>
                        <hr>
                    </div> --}}
                                            ...
                                            <div class="row m-0">
                                                ...
                                                <div class="col-md-1 p-0">
                                                    <div class="flbg text-center">
                                                        {{ $pnr->departuresector->sector_name }}
                                                    </div>
                                                ...
                                                <div class="col-md-1 p-0">
                                                    ...
                                                    <div class="flbg text-center">
                                                        {{ number_format($pnr->adult_cost, 2) }}
                                                    </div>
                                                </div>
                                                <div class="col-md-1 p-0">
                                                    <div class="flbg text-center">Child Price</div>
                                                    <div class="flbg text-center">
                                                        {{ number_format($pnr->child_cost, 2) }}
                                                    </div>
                                                </div>
                                                <div class="col-md-1 p-0">
                                                ...
                                                <div class="col-md-1 p-0">
                                                    <button type="button" data-toggle="modal"
                                                        ...
                                                        class="btn secondary-btn flbg_bttn ml-sm-0"
                                                        title="Ticket Enquiry" tabindex="0"
                ...
                @if (count($pnrs) < $totalTickets)
                    <div class="text-center my-4">
                        <button class="button" wire:click.prevent="loadMore">Load More</button>
                    </div>
                @endif
    ...
    @livewire('user.pages.ticket-view-modal-component')
</div>
@push('extra_css')
    <style>
        body .fAWLEZ {
