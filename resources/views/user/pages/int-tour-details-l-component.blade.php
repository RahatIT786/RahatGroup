                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-12">
                        ...
                        <div class="banner-sub-title-details">
                            {{ $tours->nights + 1 }}  days, {{ $tours->nights }} nights, <span><i class="fa fa-map-marker"></i> {{ $tours->country->countryname }}</span>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select class="custom-select">
                                    @foreach ($packageTypes as $pkgType)
                                    <option categoryname="Deluxe" value="{{ $pkgType->id }}" selected="">{{ $pkgType->package_type }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-7 col-sm-6 col-12">
                        ...
                        <div class="detail-tabbing-whitesec">
                            ...
                            <div>
                                <div id="Hotelstab" class="hidden" wire:ignore.self>
                                   
                                    @foreach ($packageTypes as $pkgType)
                                        <label class="radio-inline">
                                            <input class="hotelbuttonCategoryStandard" type="radio" name="optradio"
                                                autocomplete="off" wire:model="selectedPackageType"
                                                wire:change="changeType" value="{{ $pkgType->id }}">
                                            ...
                                            <tbody>
                                                @if ($selectedPackageType)
                                                    @foreach ($tours->tourDetails as $details)
                                                        @if ($details->tour_type_id == $selectedPackageType)
                                                            <tr>
                                                                <td>
                                                                    <div class="tab-title-txt-cls-inner day-pt">
                                                                        {{ $details->destination->name }}
                                                                        ({{ $details->nights }} Nights)
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="tab-title-txt-cls-inner">
                                                                        {{ $details->hotel->hotel_name }}
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="tab-title-txt-cls-inner">
                                                                        {{ $details->hotel->star_rating }}
                                                                        {{ is_numeric($details->hotel->star_rating) ? 'Star' : '' }}
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="tab-title-txt-cls-inner">Breakfast (CP)
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        @endif
