                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="filter-sec shadow filter-box-package">
                            ...
                            <div class="fl-checkbox fl-checkbox_list2 filter_heightauto">
                                <div class="fl-title">Categories </div>
                                <div class="filter-height">
                                    @foreach ($tourCategories as $category)
                                        <div class="custom-control custom-checkbox">
                                            <input type="radio" class="custom-control-input filtercheckbox filter-nn"
                                                id="inlineCheckTour{{ $category->id }}" value="{{ $category->id }}"
                                                autocomplete="off" wire:change="changeInput"
                                                wire:model.live='selectedTourTypes'>
                                            <label class="custom-control-label"
                                                for="inlineCheckTour{{ $category->id }}">
                                ...
                                <div class="fl-checkbox fl-checkbox_list2 filter_heightauto">
                                    ...
                                    <div class="filter-height">
                                        @foreach ($price_filter as $price)
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                    class="custom-control-input filtercheckbox filter-nn"
                                                    id="inlineCheckPrice{{ $price->id }}"
                                                    value="{{ $price->id }}" autocomplete="off"
                                                    wire:change="changeInput" wire:model.live='selected_price_ranges'>
                                                <label class="custom-control-label"
                                                    for="inlineCheckPrice{{ $price->id }}">Rs
                                                            ...
                                                            <div class="mt-2">
                                                                <div class="bbb">
                                                                    <a class="mdr svmdr detail_link detailbtn-mobile detail_link_274"
                                                                        href="{{ route('domesticTourDetails', $tour->slug) }}">View
                                                                        Details</a>
                                                                    <a id="estinamtebtnid"
...
@push('extra_js')
    <script>
        document.addEventListener('livewire:initialized', function() {
            window.addEventListener('triggerCategoryChange', function(e) {
                const {
                    value,
                    key
                } = e.detail;
                @this.call('selectedflavour', value, key);
            });
        });
    </script>
@endpush
