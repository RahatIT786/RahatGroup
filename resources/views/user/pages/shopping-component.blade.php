            ...
            <div class="row mx-0">
                <div class="col-md-12 px-0">
                    <div class="text-right" id="book_btn">
                        <button type="submit" href="javascript:void(0);" font-size="smallest" data-toggle="modal" data-target="#shoppingModal" class="btn secondary-btn" name="btn_kit_enquiry">Enquiry Now</button>
    ...
    <script>
        ...
        function toggleText(id) {
            ...
            if (readMore.style.display !== 'none') {
                // Load the full text
                textDiv.innerHTML = `{!! isset($shopping) ? \App\Helpers\Helper::limitTextReadMore($shopping->description, 120, '...', false) : '' !!}`;
