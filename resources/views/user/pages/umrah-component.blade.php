                    ...
                    <div class="filter-sec shadow filter-box-package">
                        <div class="filter-title">
                            <div class="fl-title filter-result">
                                ...
                                <span>{{ $totalPackages }}</span> packages <small>(Packages)</small>
                            </div>
                        ...
                        <div style="margin-bottom: 15px;">
                            <div class="wrapper">
                                ...
                                <div class="price-input">
                                    <div class="field">
                                        <span>Min</span>
                                        <input type="number" class="input-min" min="3" max="30"
                                            wire:model.lazy="minNights">
                                    </div>
                                    <div class="separator">-</div>
                                    <div class="field">
                                        <span>Max</span>
                                        <input type="number" class="input-max" min="3" max="30"
                                            wire:model.lazy="maxNights">
                                    </div>
                                </div>
                                <!-- Slider for min and max nights -->
                                <div class="slider">
                                    <div class="progress"
                                        style="left: {{ (($minNights - 3) / 27) * 100 }}%; right: {{ 100 - (($maxNights - 3) / 27) * 100 }}%;">
                                    </div>
                                </div>
                                <div class="range-input">
                                    <input type="range" class="range-min" min="3" max="30" step="1"
                                        value="{{ $minNights }}" oninput="@this.set('minNights', this.value)">
                                    <input type="range" class="range-max" min="3" max="30" step="1"
                                        value="{{ $maxNights }}" oninput="@this.set('maxNights', this.value)">
                                </div>
                            </div>
                        </div>
                        ...
                        <hr />
                        <h6 wire:ignore class="mt-2" style="cursor:pointer;" data-toggle="collapse"
                            data-target="#collapse2" aria-expanded="false" aria-controls="collapse2">Departure City</h6>
                        <div wire:ignore class="fl-checkbox fl-checkbox_list2 filter_heightauto collapse" id="collapse2"
                        ...
                        <hr />
                        <h6 wire:ignore class="mt-2" style="cursor:pointer;" data-toggle="collapse"
                            data-target="#collapse3" aria-expanded="false" aria-controls="collapse3">Month of Travel
                        </h6>
                        <div wire:ignore class="fl-checkbox fl-checkbox_list2 filter_heightauto collapse" id="collapse3"
                            aria-labelledby="heading3">
                            @foreach ($months as $month_id => $month)
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input filterradio filter-nn pkg-type"
                                        id="month_{{ $month_id }}"
                                        value="{{ $month_id }}-{{ $month['year'] }}" wire:model="selectedMonth"
                                        wire:change="changeInput" autocomplete="off">
                                    <label class="custom-control-label"
                                        for="month_{{ $month_id }}">{{ $month['month'] }}
                                        {{ $month['year'] }}</label>
                                </div>
                            @endforeach
                        </div>
                                                ...
                                                <div class="list-box">
                                                    ...
                                                    <div class="detail-right">
                                                        <div class="dropdown selectroom_cls-box">
                                                            ...
                                                            <select
                                                                wire:change="changeflavour($event.target.value, {{ $key }})"
                                                        ...
                                                        <div class="dt-2 mobile_price">
                                                            <strong>
                                                                <span>₹</span>
                                                                <span wire:loading
                                                                wire:target="changeflavour">Loading...</span>
                                                                <span wire:loading.remove
                                                                    class="pkg-price">{{ number_format($selectedFlavourPrice[$key], 2) }}</span>
                                                            </strong>
                                                        </div>
                                                        ...
                                                        <div class="sharelist">
                                                            <div class="mt-2">
                                                                <div class="bbb">
                                                                    ...
                                                                    href="{{ route('umrahPackagesView', ['id' => $package->id,'type' => $selectedFlavour[$key]['pkg_type_id']]) }}"
