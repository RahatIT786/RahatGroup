                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="fl-img liting-img">
                                                ...
                                                @else
                                                    <img src="{{ asset('storage/NoImageFound.png') }}" alt="Image"
                                                        title="" border="0">
                                                @endif
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="dt-2 mobile_price">
                                                        <strong>
                                                            ...
                                                            <span wire:loading.remove
                                                                class="pkg-price">{{ number_format($this->selectedFlavourPrice[$key], 2) }}</span>
                                                        </strong>
                                                    </div>
                                                        ...
                                                        <div class="mt-2">
                                                            <div class="bbb">
                                                                <a class="mdr svmdr detail_link detailbtn-mobile"
                                                                    href="{{ route('umrahLandPackagesView', ['id' => $package->id, 'type' => $selectedFlavour[$key]['pkg_type_id']]) }}">View
                                                                    Details</a>
