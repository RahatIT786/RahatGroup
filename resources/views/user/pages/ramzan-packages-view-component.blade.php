<div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                            ...
                            <div class="row gx-3">
                                ...
                                <div class="col-5 text-end">
                                    @php
                                        ...
                                        // dd($props,$city_id,$selected_date,$airline_id,$pkg_flavour_id);
                                    @endphp
                        ...
                        <div class="topmargin20">
                            <a class="downloaditnerybtn" href="{{ route('downloadUmrahPackage', $packages->id) }}"
                                ...
                                <div class="dt-box-1 shadow">
                                    <div class="tabnav">
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            {{-- <li>
                                                <a href="#details_tab4" class="" aria-controls="details_tab4"
                                                    role="tab" data-toggle="tab" aria-expanded="false"
                                                    aria-selected="false">Package Includes</a>
                                            </li> --}}
                                            <li>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="details_tab7">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-6 infotxt" id="">
                                                    <div class="packagehotelbox packagebox">
                                                        <h4>Inclusion</h4>
                                                        <ul>
                                                            {!! $packages->inclusion !!}
                                                        </ul>
    ...
    @livewire(
        'user.pages.ramzan-package-view-modal-component',
        [
            'id'            => $packageId,
