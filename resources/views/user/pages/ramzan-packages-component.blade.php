                    ...
                    <div class="filter-sec shadow filter-box-package">
                        <div class="filter-title">
                            <div class="fl-title filter-result">
                                ...
                                <span>{{ $totalPackages }}</span> packages
                            </div>
                        ...
                        <div wire:ignore class="fl-checkbox fl-checkbox_list2 filter_heightauto collapse show"
                            id="collapse2" aria-labelledby="heading2">
                            @foreach ($cities as $key => $city)
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input filterradio filter-nn pkg-type"
                                        id="city_{{ $key }}" value="{{ $key }}"
                                        wire:model="selectedCity" wire:change="changeInput" autocomplete="off">
                                    <label class="custom-control-label"
                                        for="city_{{ $key }}">{{ $city }}</label>
                                </div>
                            @endforeach
                        </div>
                        <hr />
                        ...
                        <div wire:ignore class="fl-checkbox fl-checkbox_list2 filter_heightauto collapse "
                            ...
                            @foreach ($packageType as $packageTypeId => $packageTypeName)
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input filterradio filter-nn pkg-type"
                                        ...
                                        wire:model="selectedPackageTypes" wire:change="changeInput"
                                        autocomplete="off">
                                    <label class="custom-control-label"
                        ...
                        <div wire:ignore class="fl-checkbox fl-checkbox_list2 filter_heightauto collapse"
                            id="collapse3" aria-labelledby="heading3">
                                                            ...
                                                            <div class="mt-2">
                                                                <div class="bbb">
                                                                    ...
                                                                    <a class="mdr svmdr detail_link detailbtn-mobile"
                                                                        href="{{ route('ramzanPackagesView', ['id' => $package->id, 'type' => $selectedFlavour[$key]['pkg_type_id']]) }}"
