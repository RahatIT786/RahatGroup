<main class="cAJbgc" style="margin-top: 0px;">
    <div class="bannercls">
        <picture>
            <source media="(min-width:980px)" srcset="{{ asset('assets/user-front/images/international-travel-banner.jpg') }}">
            <source media="(min-width:400px)" srcset="{{ asset('assets/user-front/images/international-travel-banner.jpg') }}">
            <img src="{{ asset('assets/user-front/images/international-travel-banner.jpg') }}" title="" alt=""
                border="0">
        </picture>
        <div class="box">
            <div class="container">
                ...
                @foreach ($countries as $country)
                    <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                        <div class="tour-package-box">
                            <a href="{{ route('intTourListing',$country->id) }}">
                                <picture>
                                    <source media="(min-width:980px)"
                                        srcset="{{ asset('storage/country_img/65_1710157380.jpg') }}">
                                    <source media="(min-width:400px)"
                                        srcset="{{ asset('storage/country_img/65_1710157380.jpg') }}">
                                    <img class="round" src="{{ asset('storage/country_img/65_1710157380.jpg') }}"
                                        title="{{ $country->countryname }}" alt="{{ $country->countryname }}" border="0">
                                </picture>
                                <span class="package-title">{{ $country->countryname }}</span>
                            </a>
                        </div>
                    </div>
                @endforeach
