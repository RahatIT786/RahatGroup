<div class="modal fade" id="forexenquiry" tabindex="-1" role="dialog" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background:#B49164;color:#ffffff;">
                <h3 class="modal-title h5 mb-0 text-white">Forex Enquiry Form</h3>
                        ...
                        <div class=" col-lg-8 col-sm-12 col-12 ml-auto">
                            ...
                            <form id="sendForex" class="sendForex ng-pristine ng-valid" method="post"
                                ...
                                <div class="col-md-12 d-flex text-center">
                                    <p><button type="submit" class="submit-btn btn sendForexSubmit">Send
                                            Enquiry</button></p>
                                </div>
                            </form>
                        </div>
