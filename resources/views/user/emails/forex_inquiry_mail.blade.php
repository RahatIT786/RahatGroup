        ...
        <div class="email-container">
            <div style="padding: 20px;">
                ...
                <div class="mailheader">
                    ...
                    <p style="margin:0px;color:#206099;font-size:16px;">We have received Inquiry for forex</p>
                </div>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:0;">
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue">
                                    <strong>{{ Helper::uppercase($forexenquiry->unique_id) }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Full Name</div>
                                <div class="textvalue"><strong>{{ $forexenquiry->full_name }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Mobile No</div>
                                <div class="textvalue"><strong>{{ $forexenquiry->mob_num }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Email Id</div>
                                <div class="textvalue"><strong>{{ $forexenquiry->email_id }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Currency</div>
                                <div class="textvalue">
                                    <strong>{{ $forexenquiry->currency ? $forexenquiry->currency->name : 'N/A' }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Amount</div>
                                <div class="textvalue"><strong>{{ $forexenquiry->amount }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Address</div>
                                <div class="textvalue"><strong>{{ $forexenquiry->address }}</strong></div>
                            </td>
                        </tr>
                    </table>
                </div>
