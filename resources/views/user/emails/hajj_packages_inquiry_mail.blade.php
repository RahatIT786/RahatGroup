...
<head>
    <title>hajjpackages Inquiry</title>
        ...
        <div class="email-container">
            <div style="padding: 20px;">
                ...
                <div class="mailheader">
                    ...
                    <p style="margin:0px;color:#206099;font-size:16px;">We have received Inquiry for hajjpackages</p>
                </div>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:0;">
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue"><strong>{{ Helper::uppercase($hajjpackages->unique_id) }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Full Name</div>
                                <div class="textvalue"><strong>{{ $hajjpackages->cust_name }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Mobile No</div>
                                <div class="textvalue"><strong>{{ $hajjpackages->cust_num }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Email Id</div>
                                <div class="textvalue"><strong>{{ $hajjpackages->cust_email }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Message</div>
                                <div class="textvalue"><strong>{{ $hajjpackages->cust_msg }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                        ...
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue">
                                    <strong>{{ $hajjpackages->travel_date ? Helper::formatCarbonDate($hajjpackages->travel_date) : '' }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                        ...
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue"><strong>{{ $hajjpackages->food == 1 ? 'Yes' : 'No' }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">visa</div>
                                <div class="textvalue"><strong>{{ $hajjpackages->visa == 1 ? 'Yes' : 'No' }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">airticket</div>
                                <div class="textvalue"><strong>{{ $hajjpackages->air_ticket == 1 ? 'Yes' : 'No' }}
                                    </strong></div>
                            </td>
                        </tr>
                    </table>
