    ...
    <div
        ...
        <div class="email-container">
            <div style="padding: 20px;">
                <div style="text-align: center; background-color: #ababab;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:0;">
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue">
                                    <strong>{{ Helper::uppercase($bookingenquiry->unique_id) }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Full Name</div>
                                <div class="textvalue"><strong>{{ $bookingenquiry->name }}</strong></div>
                            </td>
                        ...
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue"><strong>{{ $bookingenquiry->email }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Mobile No</div>
                                <div class="textvalue"><strong>{{ $bookingenquiry->mobile_num }}</strong></div>
                            </td>
                            {{-- <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Comments</div>
                                <div class="textvalue"><strong>{{ $bookingenquiry->comment }}</strong></div>
                            </td> --}}
                        </tr>
                        {{-- <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">visa</div>
                                <div class="textvalue"><strong>{{ $bookingenquiry->visa == 1 ? 'Yes' : 'No' }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">airticket</div>
                                <div class="textvalue"><strong>{{ $bookingenquiry->air_ticket == 1 ? 'Yes' : 'No' }}
                                    </strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Comments</div>
