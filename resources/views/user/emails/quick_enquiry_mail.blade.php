        ...
        <div class="email-container">
            <div style="padding: 20px;">
                ...
                <div class="mailheader">
                    ...
                    <p style="margin:0px;color:#206099;font-size:16px;">We have received Inquiry for quickenquiry</p>
                </div>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:0;">
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue">
                                    <strong>{{ Helper::uppercase($quickEnquiry->unique_id) }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Name</div>
                                <div class="textvalue"><strong>{{ $quickEnquiry->name }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Email</div>
                                <div class="textvalue"><strong>{{ $quickEnquiry->email }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Mobile</div>
                                <div class="textvalue"><strong>{{ $quickEnquiry->mobile_num }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Whatsapp Number</div>
                                <div class="textvalue"><strong>{{ $quickEnquiry->whatsapp_num }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">City</div>
                                <div class="textvalue"><strong>{{ $quickEnquiry->city_name }}</strong></div>
                            </td>
                        </tr>
                    </table>
                </div>
