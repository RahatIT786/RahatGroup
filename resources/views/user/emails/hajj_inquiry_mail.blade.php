...
<head>
    <title>hajjpackage Inquiry</title>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:0;">
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue"><strong>{{ Helper::uppercase($hajjpackage->unique_id) }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Full Name</div>
                                <div class="textvalue"><strong>{{ $hajjpackage->cust_name }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Mobile No</div>
                                <div class="textvalue"><strong>{{ $hajjpackage->cust_num }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Email Id</div>
                                <div class="textvalue"><strong>{{ $hajjpackage->cust_email }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Message</div>
                                <div class="textvalue"><strong>{{ $hajjpackage->cust_msg }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                        ...
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue">
                                    <strong>{{ $hajjpackage->travel_date ? Helper::formatCarbonDate($hajjpackage->travel_date) : '' }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                        ...
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue"><strong>{{ $hajjpackage->food == 1 ? 'Yes' : 'No' }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">visa</div>
                                <div class="textvalue"><strong>{{ $hajjpackage->visa == 1 ? 'Yes' : 'No' }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">airticket</div>
                                <div class="textvalue"><strong>{{ $hajjpackage->air_ticket == 1 ? 'Yes' : 'No' }}
                                    </strong></div>
                            </td>
                        </tr>
                    </table>
