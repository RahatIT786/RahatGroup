...
<head>
    ...
    <title>CallUsBack Inquiry</title>
        ...
        <div class="email-container">
            <div style="padding: 20px;">
                ...
                <div class="mailheader">
                    ...
                    <p style="margin:0px;color:#206099;font-size:16px;">We have received Inquiry for callusback</p>
                </div>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:0;">
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue"><strong>{{ Helper::uppercase($callusback->unique_id) }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Full Name</div>
                                <div class="textvalue"><strong>{{ $callusback->full_name }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Mobile No</div>
                                <div class="textvalue"><strong>{{ $callusback->mob_num }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Email Id</div>
                                <div class="textvalue"><strong>{{ $callusback->email_id }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Time</div>
                                <div class="textvalue"><strong>{{ $callusback->callback_time }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Date</div>
                                <div class="textvalue">
                                    <strong>{{ $callusback->callback_date ? Helper::formatCarbonDate($callusback->callback_date) : '' }}</strong>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue"><strong>{{ $countryname }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                            ...
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue"><strong>{{ $callusback->address }}</strong></div>
                            </td>
