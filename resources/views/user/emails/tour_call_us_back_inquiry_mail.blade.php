...
<head>
    <title>TourCallUsBack Inquiry</title>
...
background-position: top; padding: 20px;">
        ...
        <div class="email-container">
            <div style="padding: 20px;">
                <div style="text-align: center;background-color: #ababab;margin-bottom:20px;">
                ...
                <div class="mailheader">
                    ...
                    <p style="margin:0px;color:#206099;font-size:16px;">We have received Inquiry for TourCallUsBack</p>
                </div>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:0;">
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                ...
                                <div class="textvalue">
                                    <strong>{{ Helper::uppercase($tourcallusback->unique_id) }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Full Name</div>
                                <div class="textvalue"><strong>{{ $tourcallusback->full_name }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Mobile No</div>
                                <div class="textvalue"><strong>{{ $tourcallusback->mob_num }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Email Id</div>
                                <div class="textvalue"><strong>{{ $tourcallusback->email_id }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Travel Date</div>
                                <div class="textvalue">
                                    <strong>{{ $tourcallusback->travel_date ? Helper::formatCarbonDate($tourcallusback->travel_date) : '' }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Destination</div>
                                <div class="textvalue"><strong>{{ $tourcallusback->destination }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Adults</div>
                                <div class="textvalue">
                                    <strong>{{ $tourcallusback->adults }}</strong>
                                </div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Children</div>
                                <div class="textvalue"><strong>{{ $tourcallusback->children }}</strong></div>
                            </td>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Infants</div>
                                <div class="textvalue"><strong>{{ $tourcallusback->infants }}</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0;width:33.3333%; padding-right:10px;">
                                <div class="textlabel">Message</div>
                                <div class="textvalue"><strong>{{ $tourcallusback->remarks }}</strong></div>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="footer">
                ...
                <table style="background: #333333;width:100%;color:#ffffff;">
                    <tr>
                        <td colspan='2' style="text-align: center;">Need More help? We are Here , Ready to Talk.</td>
                    </tr>
                    <tr>
                        <td style="text-align: right;width:50%;padding-right:20px;">
                            <p><strong>Email :</strong> {{ $adminSetting }}</p>
                        </td>
                        <td style="width:50%;">
