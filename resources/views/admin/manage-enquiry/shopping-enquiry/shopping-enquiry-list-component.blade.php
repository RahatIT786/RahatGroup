    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.shoppingenquiry.index') }}"
                        wire:navigate>{{ __('tablevars.shopping') }}</a></div>
                            ...
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    <input type="text" name="search_name" id="search_name"
                                        ...
                                        placeholder="Search Name" autocomplete="off" wire:keyup="filterShopping">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        @forelse ($Shopping as $key => $shopping)
                                            <tr>
                                                ...
                                                <td>{{ Helper::uppercase($shopping->unique_id ?? '') }}</td>
                                                <td>{{ $shopping->name ?? '' }}</td>
                                                ...
                                                @endphp
                                                    @if (array_key_exists($shopping->status, $statusLabels))
                                                        <div
                                                            class="badge {{ $statusLabels[$shopping->status]['class'] }}">
                                                    ...
                                                    <div class="ticket-grp mb-2 has-submenu">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start"
                                                            ...
                                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                                                ...
                                                                wire:click="getModalContent({{ $shopping->id }})">View</a>
                                                            ...
                                                            <a class="dropdown-item text-danger"
                                                                ...
                                                                wire:click='isDelete({{ $shopping->id }})'>Trash</a>
                                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                                                class="dropdown-item"
                                                                data-bs-target="#relationshipModal"
                                                                data-toggle="tooltip"
                                                                title="Assign Relationship Manager"
                                                                wire:click="getModalRelationship({{ $shopping->id }})">Assign
                            ...
                            <div class="d-flex flex-row justify-content-between align-items-center table-pagination">
                                <div class="d-flex align-items-center">
                                    ...
                                    <select name="per_page" id="per_page" class="form-control">
                                        wire:model='perPage' wire:change='filterShopping'>
