<div class="main-content">
    ...
    <section class="section">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th>{{ __('tablevars.#') }}</th>
                                            <th>{{ __('tablevars.cmpname') }} </th>
                                            <th>{{ __('tablevars.accname') }} </th>
                                            <th>{{ __('tablevars.accno') }} </th>
                                            <th>{{ __('tablevars.ifsc') }}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $account->iban_no }}</td>
                                            <td>{{ $account->gst }}</td>
                                            <td>{{ $account->pan_card }}</td>
                                            <td>
                                                @if($account->active_status == 1)
                                                    <span class="pointer badge badge-primary">Active</span>
                                                @else
                                                    <span class="pointer badge badge-danger">Inactive</span>
                                                @endif
                                            </td>
                                            <td>
                                                <div class="btn-group mb-2">
                                                    ...
                                                    <div class="dropdown-menu" x-placement="bottom-start"
                                                        ...
                                                        wire:click='isDelete({{ $account->id }})'>Trash</a>

                                                        <a class="dropdown-item"
                                                        href="javascript:void(0)"data-bs-toggle="modal"
                                                        data-bs-target="#bankAccountModal" data-toggle="tooltip"
                                                        title="View"
                                                        wire:click="getAgentContent({{ $account->id }})">View</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
     ...
     <!-- Modal -->
     <div wire:ignore.self class="modal fade" id="bankAccountModal" data-bs-backdrop="static" data-bs-keyboard="false"
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>{{ $bankAccount->company_name ?? '---' }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>{{ $bankAccount->account_no ?? '---' }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>IFSC/SWIFT</label>
                                        <div>{{ $bankAccount->ifsc_swift ?? '---' }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>{{ $bankAccount->branch_name ?? '---' }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>IBAN Number</label>
                                        <div>{{ $bankAccount->iban_no ?? '---' }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>GST</label>
                                        <div>{{ $bankAccount->gst ?? '---' }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>PAN Card</label>
                                        <div>{{ $bankAccount->pan_card ?? '---' }}</div>
                                    </div>
                                </div>
                              @else
                                <div class="col-12">
