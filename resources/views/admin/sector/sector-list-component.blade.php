<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ __('tablevars.sector') }}</h1>
            <div class="section-header-button">

            </div>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active">{{ __('tablevars.sector') }} {{ __('tablevars.managment') }}
                </div>
                <div class="breadcrumb-item"><a href="{{ route('admin.addSector.index') }}"
                        wire:navigate>{{ __('tablevars.sector') }}</a></div>
                <div class="breadcrumb-item">{{ __('tablevars.all') }} {{ __('tablevars.sector') }}</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3">
                                    <label class="label-header" for="search_sector">{{ __('tablevars.sector') }}</label>
                                    <input type="text" name="search_sector" id="search_sector" class="form-control"
                                        placeholder="Search Sector" autocomplete="off" wire:model='search_sector' wire:keyup="filterSector">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.sector') }} {{ __('tablevars.list') }}</h4>
                                    ...
                                    <tbody>
                                        @forelse ($sectors as $key => $sector)
                                            <tr>
                                                ...
                                                <td>{{ App\Helpers\Helper::textCut($sector->sector_name ?? '---') }}</td>
                                                <td>
                                                    <div
                                                        class="pointer badge badge-{{ $sector->is_active == 1 ? 'primary' : 'danger' }}" wire:click="toggleStatus({{ $sector->id }})">
                                                    ...
                                                    <div class="btn-group mb-2">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start"
                                                            ...
                                                            <a href="javascript:void(0)" class="dropdown-item"
                                                                ...
                                                                data-toggle="tooltip" title="Edit Sector">Edit</a>
                ...
                <form wire:submit.prevent="{{ $is_edit ? 'update' : 'save' }}">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="crudModalLabel">{{ $is_edit ? 'Edit Sector' : 'Add Sector' }}</h5>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sector_name" wire:model="sector_name"
                                            id="sector_name" placeholder="Please enter sector name" maxlength="50">
                                        @error('sector_name')
