        ...
        <tr>
            <td style="width:50%;">
                <h2 style="color: #282828;font-weight: 400;margin: 0 auto 1px;font-family: Open Sans;">Booking Id :
                    {{ $clientData->booking_id }}</h2>
                <p>{!! $clientData->agency->agency_name ?? '' !!}<br>{!! $clientData->agency->city ?? '' !!}<br>{{ $clientData->agency->mobile ?? '' }}
                </p>
            </td>
            <td style="width:50%;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td
                                ...
                                {{ $clientData->servicetype->name ?? '' }}</td>
                        </tr>
                        <tr>
                            <th
                                style="padding:6px; line-height: 2.428571429;width:40%;border: 1px solid #b8cbd4;background-color:#f5f7f8;font-size:14px;font-family:Helvetica Neue;">
                            ...
                            <td
                                style="padding:6px;width:60% ;font-family:verdana;font-size:14px;border: 1px solid #b8cbd4;color:#4c606a;">
                                Name : {{ $clientData->package->name ?? '' }}, <br>
                                Type : {{ $clientData->packagetype->package_type ?? '' }}</td>
                        </tr>
                        <tr>
                            <th
                                style="padding:6px; line-height: 2.428571429;width:40%;border: 1px solid #b8cbd4;background-color:#f5f7f8;font-size:14px;font-family:Helvetica Neue;">
                            ...
                            <td
                                style="padding:6px;width:60% ;font-family:verdana;font-size:14px;border: 1px solid #b8cbd4;color:#4c606a;">
                                {{ $clientData->sharingtype->name ?? '' }}</td>
                        </tr>
                        <tr>
                            <th
                                style="padding:6px; line-height: 2.428571429;width:40%;border: 1px solid #b8cbd4;background-color:#f5f7f8;font-size:14px;font-family:Helvetica Neue;">
                            ...
                            <td
                                style="padding:6px;width:60% ;font-family:verdana;font-size:14px;border: 1px solid #b8cbd4;color:#4c606a;">
                                {{ $clientData->travel_date ? Helper::formatCarbonDate($clientData->travel_date) : '' }}
                            </td>
                        </tr>
                        <tr>
                            <th
                            ...
                            <td
                                style="padding:6px;width:60% ;font-family:verdana;font-size:14px;border: 1px solid #b8cbd4;color:#4c606a;">
                                {{ $clientData->tot_cost != '' ? number_format($clientData->tot_cost, 2) : '' }}</td>
                        </tr>
                    </tbody>
                </table>
            </td>
    ...
    <table width="100%" cellspacing="5" cellpadding="5" style="border-collapse:collapse;margin-top:15px;border: none;"
        ...
        <tbody>
            @php
                $tot_debit = 0;
                $tot_credit = 0;
                $debit_balance1 = $clientData->tot_cost;
            @endphp
            <tr>
                <th
            ...
            @foreach ($clientData->payment as $payment)
                @php
            ...
            <tr>
                ...
                <td
                    ...
                    {{ number_format($clientData->tot_cost, 2) }}
                </td>
                <td
                    style="padding:6px;font-family:verdana;font-size:14px;border: 1px solid #b8cbd4;background-color:#f5f7f8;color:#4c606a;">
                    {{ number_format($tot_debit, 2) }}</td>
            </tr>
            <tr>
                <td style="padding:6px;font-family:verdana;font-size:14px;border: 1px solid #b8cbd4;color:#4c606a;"
                ...
                <td
                    ...
                    {{ number_format($clientData->tot_cost - $tot_debit, 2) }}</td>
            </tr>
        </tbody>
    </table>
