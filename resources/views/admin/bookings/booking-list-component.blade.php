                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('tablevars.active') }} {{ __('tablevars.status') }}</th>
                                    ...
                                    <tbody>
                                        @forelse ($bookings as $key => $booking)
                                            @php
                                                $totalPaymentAmount = $booking->payments
                                                    ->where('is_paid', 1)
                                                    ->where('payment_status', 1)
                                                    ->sum('amount');
                                                $full_paymenmtnt_discount =
                                                    $booking->full_payment_discount != 0
                                                        ? $booking->full_payment_discount
                                                        : 0;
                                                $balance =
                                                    $booking->tot_cost -
                                                    $totalPaymentAmount -
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        ...
                                                        $activeLabels = [
                                                            ...
                                                            1 => ['label' => 'Active', 'class' => 'badge-primary'],
                                                        ];
                                                    @endphp

                                                    @if (array_key_exists($booking->booking_status, $statusLabels))
                                                        <div
                                                            class="badge {{ $statusLabels[$booking->booking_status]['class'] }}">
                                                ...
                                                <td>
                                                    <div
                                                        class="badge {{ $activeLabels[$booking->is_active]['class'] }}">
                                                        {{ $activeLabels[$booking->is_active]['label'] }}
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="btn-group mb-2">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start"
                                                            ...
                                                            <a href="javascript:void(0)"
                                                                class="dropdown-item text-{{ $booking->is_active == 1 ? 'danger' : 'primary' }}"
                                                                wire:click='isActive({{ $booking->id }})'>{{ $booking->is_active == 1 ? 'Deactivate' : 'Activate' }}</a>
                                    ...
                                    @if ($booking_modal_data)
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>{{ $booking_modal_data->servicetype->name }} </br>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    {{ $booking_modal_data->package->name != null ? $booking_modal_data->package->name : '-' }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    {{ $booking_modal_data->packagetype->package_type != null ? $booking_modal_data->packagetype->package_type : '-' }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>₹{{ number_format($booking_modal_data->tot_cost, 2) }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
