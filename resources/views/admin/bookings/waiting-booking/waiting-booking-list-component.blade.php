<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ $currentSegment }} {{ __('tablevars.booking') }} {{ __('tablevars.waiting') }} </h1>
            <div class="section-header-button">

            </div>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active">{{ __('tablevars.waiting') }} {{ __('tablevars.booking') }} {{ __('tablevars.managment') }}</div>
                <div class="breadcrumb-item"><a href="{{ route('admin.booking.index') }}"
                        wire:navigate>{{ __('tablevars.waiting') }} {{ __('tablevars.booking') }}</a></div>
                <div class="breadcrumb-item">{{ __('tablevars.all') }} {{ __('tablevars.waiting') }} {{ __('tablevars.booking') }} {{ __('tablevars.list') }}</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.waiting') }} {{ __('tablevars.booking') }} {{ __('tablevars.list') }}</h4>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        {{-- {{ dd($bookings) }} --}}
                                        @forelse ($WaitingBooking as $key => $booking)
                                            {{-- {{ dd($booking->agency->id) }} --}}
                                            <tr>
                                                <td>{{ $key + $WaitingBooking->firstItem() }}</td>
                                                ...
                                                <td>
                                                    {{-- {{ Helper::properDecimals($booking->tot_cost) }} --}}
                            ...
                            <div class="d-flex flex-row justify-content-between align-items-center table-pagination">
                                ...
                                {{ $WaitingBooking->links(data: ['scrollTo' => false]) }}
                            </div>
                        </div>
                    </div>
                </div>
