<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ $currentSegment }} {{ __('tablevars.under_review') }} {{ __('tablevars.booking') }} </h1>
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.booking.index') }}"
                        wire:navigate>{{ __('tablevars.under_review') }} {{ __('tablevars.booking') }}</a></div>
                <div class="breadcrumb-item">{{ __('tablevars.all') }} {{ __('tablevars.under_review') }} {{ __('tablevars.booking') }}</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.under_review') }} {{ __('tablevars.booking') }} {{ __('tablevars.list') }}</h4>
                            <div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($UnderReviewBooking as $key => $booking)
                                            <tr>
                                                <td>{{ $key + $UnderReviewBooking->firstItem() }}</td>
                                                <td>{{ $booking->booking_id }}</td>
                                                <td>{{ $booking->servicetype != NULL ? $booking->servicetype->name : '' }}</td>
                            ...
                            <div class="d-flex flex-row justify-content-between align-items-center table-pagination">
                                ...
                                {{ $UnderReviewBooking->links(data: ['scrollTo' => false]) }}
                            </div>
                        </div>
                    </div>
                </div>
