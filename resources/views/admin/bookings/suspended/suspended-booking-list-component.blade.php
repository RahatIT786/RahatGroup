<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ $currentSegment }} {{ __('tablevars.suspended') }} {{ __('tablevars.booking') }} </h1>
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.booking.index') }}"
                        wire:navigate>{{ __('tablevars.suspended') }} {{ __('tablevars.booking') }}</a></div>
                <div class="breadcrumb-item">{{ __('tablevars.all') }} {{ __('tablevars.suspended') }}
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.suspended') }} {{ __('tablevars.booking') }}
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($Suspended as $key => $booking)
                                            <tr>
                                                <td>{{ $key + $Suspended->firstItem() }}</td>
                            ...
                            <div class="d-flex flex-row justify-content-between align-items-center table-pagination">
                                ...
                                {{ $Suspended->links(data: ['scrollTo' => false]) }}
                            </div>
                        </div>
                    </div>
                </div>
