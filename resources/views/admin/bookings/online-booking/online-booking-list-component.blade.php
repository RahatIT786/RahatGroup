<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ $currentSegment }} {{ __('tablevars.online') }} {{ __('tablevars.booking') }} </h1>
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.booking.index') }}"
                        wire:navigate>{{ __('tablevars.online') }} {{ __('tablevars.booking') }}</a></div>
                <div class="breadcrumb-item">{{ __('tablevars.all') }} {{ __('tablevars.online') }}
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.online') }} {{ __('tablevars.booking') }} {{ __('tablevars.list') }}
                            </h4>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($OnlineBooking as $key => $booking)
                                            <tr>
                                                <td>{{ $key + $OnlineBooking->firstItem() }}</td>
                            ...
                            <div class="d-flex flex-row justify-content-between align-items-center table-pagination">
                                ...
                                {{ $OnlineBooking->links(data: ['scrollTo' => false]) }}
                            </div>
                        </div>
                    </div>
                </div>
