<div class="main-content">
    ...
    <section class="section">
        <div class="section-header">
            <h1>{{ $currentSegment }} {{ __('tablevars.approved') }} {{ __('tablevars.booking') }} </h1>
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.booking.index') }}"
                        wire:navigate>{{ __('tablevars.approved') }} {{ __('tablevars.booking') }}</a></div>
                <div class="breadcrumb-item">{{ __('tablevars.all') }} {{ __('tablevars.approved') }}
                ...
                <div class="col-12">
                    ...
                    <div class="card">                      
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.approved') }} {{ __('tablevars.booking') }}
                                {{ __('tablevars.list') }}</h4>

                            <div>
                                <a href="javascript:void(0);" class="btn btn-info" style="color: white;" wire:click="exportToExcel">
                                    <i class="fas fa-file-excel"></i> Export to Excel
                                </a>
                                <a href="javascript:void(0);" style="color: white" class="btn btn-warning" wire:click="download"><i class="fas fa-print"></i>Print</a>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($approvedBookings as $key => $booking)
                                            <tr>
                                                <td>{{ $key + $approvedBookings->firstItem() }}</td>
                            ...
                            <div class="d-flex flex-row justify-content-between align-items-center table-pagination">
                                ...
                                {{ $approvedBookings->links(data: ['scrollTo' => false]) }}
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    @if ($booking_modal_data)
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>{{ $booking_modal_data->city_id != null ? $booking_modal_data->city->city_name : '-'  }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Travel Date </label>
                                                <div>{{ $booking_modal_data->travel_date != null ? $booking_modal_data->travel_date : '-'  }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Package PNR</label>
                                                <div>{{ $booking_modal_data->pnr_id != null ? $booking_modal_data->pnr->pnr_code : '-'  }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Package Name</label>
                                                <div>{{ $booking_modal_data->package_name != null ? $booking_modal_data->package_name : '-'  }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Package Type</label>
                                                <div>{{ $booking_modal_data->package_type  != null ? $booking_modal_data->package_type : '-'  }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Sharing Type</label>
                                                <div>{{ $booking_modal_data->shairing_type   != null ? $booking_modal_data->sharingtype->name : '-'  }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Package Days</label>
                                                <div>{{ $booking_modal_data->days   != null ? $booking_modal_data->days : '-'  }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>{{ $booking_modal_data->adult   != null ? $booking_modal_data->adult : '-'   }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Number of Child With Bed</label>
                                                <div>{{ $booking_modal_data->child_bed   != null ? $booking_modal_data->child_bed : '-'    }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Number of Child Without Bed</label>
                                                <div>{{ $booking_modal_data->child   != null ? $booking_modal_data->child : '-'    }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Number of Infants</label>
                                                <div>{{ $booking_modal_data->infant   != null ? $booking_modal_data->infant : '-'    }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>{{ Helper::getCanonicalDateTime($booking_modal_data->created_at) }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Updated Date</label>
                                                <div>{{ Helper::getCanonicalDateTime($booking_modal_data->updated_at) }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
    ...
    {{-- Make Payment modal --}}
    <div wire:ignore.self class="modal fade" id="paymentsStatusModal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: 85% !important;">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-2">
                                <span >{{ __('tablevars.booking') }} {{ __('tablevars.id') }} :{{ $booking_id }}</span>
                            </div>
                            </div class="col-2">
                                <span >{{ __('tablevars.total') }} {{ __('tablevars.amount') }} :{{ $total_amount }}</span>
                            </div>
                        ...
                        <form  wire:submit.prevent="paymentSave">
                            <div class="form-group row">
                              <label for="staticEmail" class="col-sm-12 col-form-label" style="color:red;">Note : Please enter an amount and click on proceed to make payment for this booking.</label>
                            </div>
                            <div class="form-group row">
                              <label for="payment_amount" class="col-sm-2 col-form-label">Amount</label>
                              <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="Enter Amount" name="payment_amount" id="payment_amount" onkeypress="return numbersonly(event);" required wire:model='payment_amount'>
                                <input type="hidden" class="form-control" name="booking_id" id="booking_id" value="'.$rows['booking_id'].'">
                              </div>
                              <button type="submit" name="btn_payment" class="btn btn-primary mb-2 col-sm-3">Proceed</button>
                            </div>
                        </form>
                    </div>
                </div>
