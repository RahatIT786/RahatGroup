<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ __('tablevars.international_destination') }}</h1>
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.destination.index') }}"
                        wire:navigate>{{ __('tablevars.international_destination') }}</a></div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.international_destination') }} {{ __('tablevars.list') }}</h4>

                            <a href="{{ route('admin.intDestination.create') }}" class="btn btn-primary"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($destinations as $key => $tourpackage)
                                            <tr>
                                                ...
                                                <td>{{ $tourpackage->country->countryname ?? '' }}</td>
                                                    ...
                                                    <div class="btn-group mb-2">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start"
                                                            ...
                                                            <a class="dropdown-item" data-toggle="tooltip"
                                                                href="{{ route('admin.intDestination.edit', $tourpackage->id) }}"
                            ...
                            <div class="d-flex flex-row justify-content-between align-items-center table-pagination">
                                ...
                                {{ $destinations->links(data: ['scrollTo' => false]) }}
                            </div>
                        </div>
                    </div>
                </div>
