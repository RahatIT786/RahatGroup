<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ __('tablevars.create') }} {{ __('tablevars.domestic_destination') }}</h1>
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ __('tablevars.add') }} {{ __('tablevars.domestic_destination') }}</div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card card-primary">
                    <form wire:submit.prevent="save">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.create') }} {{ __('tablevars.domestic_destination') }}</h4>
