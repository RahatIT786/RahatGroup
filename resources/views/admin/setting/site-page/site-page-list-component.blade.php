                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-4 mb-2">
                                    <label class="label-header" for="search_page_name">Page Name</label>
                                    <input type="text" name="search_page_name" id="search_page_name"
                                        class="form-control" wire:model='search_page_name' wire:keyup="filterSetting"
                                        placeholder="Search Page Name" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($SitePages as $key => $page)
                                            <tr>
                                                <td>{{ $key + $SitePages->firstItem() }}</td>
                                                    ...
                                                    <div class="btn-group mb-2">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start"
                                                            ...
                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                                wire:click.prevent="edit({{ $page->id }})"
                            ...
                            <div class="d-flex flex-row justify-content-between align-items-center table-pagination">
                                ...
                                {{ $SitePages->links(data: ['scrollTo' => false]) }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form wire:submit.prevent="{{ $is_edit ? 'update' : 'save' }}">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="page_name" value="About Us" id="page_name"
                                wire:model="page_name" placeholder="Please enter page name">
                            @error('page_name')
