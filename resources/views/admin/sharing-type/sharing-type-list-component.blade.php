    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active">{{ __('tablevars.sharing_type') }} {{ __('tablevars.managment') }}
                </div>
                <div class="breadcrumb-item"><a href="{{ route('admin.sharingType.index') }}"
                        wire:navigate>{{ __('tablevars.sharing_type') }}</a></div>
                <div class="breadcrumb-item">{{ __('tablevars.all') }} {{ __('tablevars.sharing_type') }}</div>
            </div>
        </div>
