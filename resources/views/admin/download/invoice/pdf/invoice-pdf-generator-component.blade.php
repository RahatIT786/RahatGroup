...
<body>
    ...
    <table>
        <tr>
            <td style="width: 60%; vertical-align: top;">
                ...
                <p><strong style="margin:0px 0px 8px;color:#480e50;">Travel Date:</strong>
                    {{ Helper::formatCarbonDate($travel_date) }}</p>
                <p><strong style="margin:0px 0px 8px;color:#480e50;">PAX:</strong> {{ $total_pax }}
                    (Adults:
                    {{ $adult }}{{ $children ? ', Children: ' . $children : '' }}{{ $infant ? ', Infants: ' . $infant : '' }})
                </p>
            </td>
    ...
    <div class="note">
        ...
        <ul>
            ...
            <li>If you travel individually other than group dates, you will bear the additional transportation charges
                as per your itinerary.</li>
            ...
            <li>We are not responsible for Waiting time at Airport / Hotel Reception due to Difference in Check-in and
                Check-out time of the Hotel in Comparison to Flight Arrival or Departure Time.</li>
        </ul>
    </div>
    ...
    <div class="cancellation-policy">
        ...
        <ul>
            ...
            <li>Date Change Penalty 5000/- per person if made between 15 to 30 days before departure or else the above
                cancellations shall apply.</li>
        </ul>
    </div>
