...
<body>
        ...
        <table width="100%" cellspacing="5" cellpadding="5"
            ...
            <tbody>
                <tr>
                    ...
                    <th
                        style="padding:6px; line-height: 2.428571429;border: 1px solid #b8cbd4;background-color:#000;color:#fff;font-size:14px;text-align: center;width:25%;">
                        Departure Date
                    </th>
                    <th
                        style="padding:6px; line-height: 2.428571429;border: 1px solid #b8cbd4;background-color:#000;color:#fff;font-size:14px;text-align: center;width:15%;">
    ...
    <h1 style="font-size:20px;background: #ffa500;color:#000000; margin:0px;">Inclusions</h1>
    <table width="100%" cellspacing="5" cellpadding="5"
        style="font-family: sans-serif;border-collapse:collapse;margin-top:15px;border: none;">
        <thead>
            <tr>
                <th
        ...
        <table style="width:100%;">
            <tr>
                <td valign="top" style="width:33.3333%;">
                    <p style="font-size:17px;color:#11752f;margin-bottom:0px;margin-top:0px;">Flight & Transport</p>
                    <div style="font-size:14px;">
                        <ul>{!! $flight_transport !!}</ul>
                    </div>
                </td>
                <td valign="top" style="width:33.3333%;">
                    <p style="font-size:17px;color:#11752f;margin-bottom:0px;margin-top:0px;">Meals</p>
                    <div style="font-size:14px;">
                        <ul>{!! $meals !!}</ul>
                    </div>
                </td>
                <td valign="top" style="width:33.3333%;">
                    <p style="font-size:17px;color:#11752f;margin-bottom:0px;margin-top:0px;">Visa & Taxes</p>
                    <div style="font-size:14px;">
                        <ul>{!! $visa_taxes !!}</ul>
                    </div>
                </td>
    ...
    {{-- <div style="border: 1px solid #e4e4e4;padding:15px;margin-bottom:20px;">
        <h1
