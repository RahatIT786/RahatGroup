        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.manageServices.index') }}"
                        wire:navigate>{{ __('tablevars.service_type') }} {{ __('tablevars.list') }}</a></div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($ServiceTypes as $key => $type)
                                            <tr>
                                                <td>{{ $key + $ServiceTypes->firstItem() }}</td>
                                                <td>{{ $type->name ?? '---' }}</td>
                                                <td>
                            ...
                            <div class="d-flex flex-row justify-content-between align-items-center table-pagination">
                                ...
                                {{ $ServiceTypes->links(data: ['scrollTo' => false]) }}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" value="About Us" id="name"
                                wire:model="name" placeholder="Please enter services name" maxlength="50">
                            @error('name')
