<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ __('tablevars.edit') }} {{ __('tablevars.header') }} {{ __('tablevars.notification') }}</h1>
                ...
                <div class="card">
                    <form wire:submit.prevent="update">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.edit') }} {{ __('tablevars.header') }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group" wire:ignore>
                                        ...
                                        <textarea input="notifi_contain" name="notifi_contain" id="notifi_contain" class="form-control"
