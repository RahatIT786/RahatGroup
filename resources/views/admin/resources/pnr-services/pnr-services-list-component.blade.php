        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.pnrServices.index') }}"
                        wire:navigate>{{ __('tablevars.pnr_service') }} {{ __('tablevars.list') }}</a></div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($PnrService as $key => $pnr)
                                            <tr>
                                                <td>{{ $key + $PnrService->firstItem() }}</td>
                                                <td>{{ $pnr->name ?? '---' }}</td>
                                                <td>
                                                    <div class="pointer badge badge-{{ $pnr->is_active == 1 ? 'primary' : 'danger' }}"
                                                        wire:click="toggleStatus({{ $pnr->id }})">
                                                        {{ $pnr->is_active == 1 ? 'Active' : 'Inactive' }}
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="btn-group mb-2">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start"
                                                            ...
                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                                wire:click.prevent="getEditData({{ $pnr->id }})"
                            ...
                            <div class="d-flex flex-row justify-content-between align-items-center table-pagination">
                                ...
                                {{ $PnrService->links(data: ['scrollTo' => false]) }}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name" value="About Us"
                                    id="name" wire:model="name" placeholder="Please enter pnr name" maxlength="20">
                                @error('name')
