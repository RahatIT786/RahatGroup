                        ...
                        <div class="card-body">
                            ...
                            <div class="col-3">
                                    <label class="label-header"
                                        for="brochure_content">{{ __('tablevars.brochure_content') }}</label>
                                    <input type="text" name="brochure_content" id="brochure_content"
                                        class="form-control" wire:model='brochure_content' placeholder="Search Brochure Content" autocomplete="off" wire:keyup="filterBrochure">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                        <th>{{ __('tablevars.#') }}</th>
                                            <th>{{ __('tablevars.brochure_content') }}</th>
                                    ...
                                    <tbody>
                                       @forelse ($Broucher as $key => $broucher) 
                                        ...
                                        <td>{{ $key + $Broucher->firstItem() }}</td>
                                                    ...
                                                    <td >{{ $broucher->brochure_content ?? ' - ' }}</td>
                                                    
                                                    <td>
                                                    <div style="cursor:pointer;" class="pointer badge badge-{{ $broucher->is_active == 1 ? 'primary' : 'danger' }}"
                                                                ...
                                                                <div class="ticket-grp mb-2 has-submenu">
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <!-- <a href="javascript:void(0)"
                                                                            ...
                                                                            href="{{ route('admin.brochure.edit', $broucher->id) }}" data-bs-toggle="modaltwo" data-bs-target="#editModal"
                                                                                data-toggle="tooltip"
