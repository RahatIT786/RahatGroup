<div class="main-content">
    ...
    <section class="section">
        <div class="section-header">
            <h1>{{ __('tablevars.create') }} {{ 'Package Master' }}</h1>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.create') }} {{ 'Package Master' }}</h4>
                        ...
                        <div id="accordion1">
                            <div class="accordion">
                                <div class="accordion-header" role="button" data-toggle="collapse"
                                    ...
                                    <h4>Payment Policy , Important Notes And Cancellation Policy</h4>
                                </div>
                                        ...
                                        <div class="col-4">
                                            <div class="input-block" wire:ignore>
                                                ...
                                                <textarea type="text" input="visa_taxes" class="form-control summernote" wire:model='visa_taxes'
                                                    id="visa_taxes">{{ $description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <label>Laundry Type<span class="text-danger">*</span></label>
