<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ __('tablevars.tour_package') }}</h1>
            <div class="section-header-button">

            </div>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active">{{ __('tablevars.tour_package') }}</div>
                <div class="breadcrumb-item"><a href="{{ route('admin.tours.index') }}">{{ __('tablevars.tour') }}
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ 'Tours Master' }} {{ __('tablevars.list') }}</h4>
                            <div>
                                                    ...
                                                    <div class="btn-group mb-2">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start"
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.tours.edit', $tour->id) }}">Edit</a>
