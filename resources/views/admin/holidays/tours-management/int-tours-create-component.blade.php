<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ __('tablevars.create') }} {{ __('tablevars.international_tour_package') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active">{{ __('tablevars.tour_management') }}</div>
                <div class="breadcrumb-item">
                    <a href="{{ route('admin.intTours.index') }}" wire:navigate>{{ __('tablevars.international_tour_package') }}</a>
                </div>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.create') }} {{ __('tablevars.international_tour_package') }}</h4>
                            <a href="{{ route('admin.intTours.index') }}" class="btn btn-danger" wire:navigate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="country" name="country" wire:model="country_id"
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" 
                                                            id="themes{{ $category->id }}" 
                                                            value="{{ $category->id }}"
                                                            wire:model="selectedThemes">
                                                        <label class="form-check-label" for="themes{{ $category->id }}">
                                                            {{ $category->cat_name }}
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            @foreach ($tour_includes as $key => $include)
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="includes{{ $key }}">
                                                            {{ $include }}
                                                        </label>
                                                    </div>
                                                </div>
    ...
    @if ($package_types)
                        ...
                        <div class="card-body">
                            <div class="row">
                                @foreach ($destinations as $destination)
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label>Hotel for {{ $destination->name }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label>Nights in {{ $destination->name }}<span class="text-danger">*</span></label>
        ...
        @endforeach
        <div class="align-right mb-4">
            <button class="btn btn-primary" id="save-button" wire:click="save">Save</button>
        </div>
    @endif
</div>
