        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.foodType.index') }}"
                        wire:navigate>{{ __('tablevars.food') }}</a></div>
                <div class="breadcrumb-item">{{ __('tablevars.all') }} {{ __('tablevars.food_type') }} </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <label class="label-header"
                                        for="search_agency">{{ __('tablevars.food_type') }}</label>
                                    <input type="text" name="search_agency" id="search_agency" class="form-control"
                                        placeholder="Search Food Type" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                ...
                                data-toggle="tooltip" title="Add new Vehicle Type">{{ __('tablevars.add') }}
                                {{ __('tablevars.new') }}</a>
                        </div>
                        <div class="card-body">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">{{ __('tablevars.food_type') }}</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="price" id="price"
                                placeholder="Please enter food type price">
                            @error('price')
                                <span class="v-msg-500">{{ $message }}</span>
                            @enderror
                        </div>
