                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>{{ __('tablevars.amount') }}</label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>{{ __('tablevars.total') }} {{ __('tablevars.amount') }}</label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="particularts" class="form-control"
                                            wire:model="particularts" maxlength="150">
                                    </div>
                                </div>
                            </div>
                        </div>
