<div class="main-content">
    ...
    <section class="section">
        <div class="section-header">
            <h1>{{ __('tablevars.approved') }} {{ __('tablevars.payment') }}</h1>
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.payment.index') }}"
                        wire:navigate>{{ __('tablevars.approved') }} {{ __('tablevars.payment') }}</a></div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.approved') }} {{ __('tablevars.payment') }}
                                {{ __('tablevars.list') }}</h4>

                            <div>
                                <a href="#" class="btn btn-info" style="color: white;" wire:click="exportToExcel">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        {{-- @php dd($AllPayments->booking);@endphp --}}
                                        {{-- @forelse ($users as $key => $user) --}}
                                        @forelse ($ApprovedPayments as $key => $AllPayment)
                                            {{-- @php dd($AllPayment->booking->agency->agency_name);@endphp --}}
                                            <tr>
                                                <td>{{ $key + $ApprovedPayments->firstItem() }}</td>
                                                ...
                                                {{-- <td>
                                                    {{ date('d-m-Y', strtotime($AllPayment->txn_date)) }}
                                                </td> --}}
                                                <td>
                                                    @php
                                                        $statusLabels = [
                                                    ...
                                                    <div class="btn-group mb-2">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start"
                                                            ...
                                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                                                ...
                                                                href="{{ route('admin.payment.approved.edit', $AllPayment->id) }}">Edit</a> --}}
                            ...
                            <div class="d-flex flex-row justify-content-between align-items-center table-pagination">
                                ...
                                {{ $ApprovedPayments->links(data: ['scrollTo' => false]) }}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewModalLabel">{{ __('tablevars.approved_payment_data') }}</h5>
                ...
                <div class="modal-body">
                    @if ($payments_modal_data)
                        <table class="table table-striped">
                            ...
                            <tr>
                                <th>{{ __('tablevars.balance') }} {{ __('tablevars.amount') }}</th>
                                <td>500000.00</td>
                            </tr>
                            <tr>
                                <th>{{ __('tablevars.deposite_type') }}</th>
                            ...
                            <tr>
                                <th>{{ __('tablevars.beneficiary') }} {{ __('tablevars.bankname') }}</th>
                                <td>{{ $payments_modal_data->bank_name }}</td>
                            </tr>
                            <tr>
                                <th>{{ __('tablevars.beneficiary_account_no') }}</th>
                                <td>{{ $payments_modal_data->bank_account_no }}</td>
                            </tr>
                            <tr>
                                <th>{{ __('tablevars.person_name') }}</th>
                            ...
                            <tr>
                                <th>{{ __('tablevars.transaction_dt') }}</th>
                                ...
                                @if ($booking_modal_data)
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div>{{ $booking_modal_data->city ? $booking_modal_data->city->city_name : '-' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Travel Date </label>
                                            <div>{{ Helper::formatCarbonDate($booking_modal_data->travel_date) }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Package PNR</label>
                                            <div>{{ $booking_modal_data->pnr ? $booking_modal_data->pnr->pnr_code : '-' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div>₹ {{ Helper::properDecimals($booking_modal_data->tot_cost)}}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
