                    ...
                    <form wire:submit.prevent="update">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>{{ __('tablevars.balance_amount') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="balance" class="form-control" wire:model="balance"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>{{ __('tablevars.chq_txn_no') }}<span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="txn_id" class="form-control" wire:model="txn_id"
                                            maxlength="50">
                                        @error('txn_id')
                                            <span class="v-msg-500">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="personal_name">{{ __('tablevars.person_name') }}</label>
                                        <input type="personal_name" type="text" class="form-control" name="personal_name"
                                            wire:model="personal_name">
                                        @error('personal_name')
                                            <span class="v-msg-500">{{ $message }}</span>
                                        @enderror
                                    </div>
