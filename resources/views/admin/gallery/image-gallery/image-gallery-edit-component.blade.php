<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ __('tablevars.edit') }} {{ __('tablevars.image_gallery') }}</h1>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.edit') }} {{ __('tablevars.image_gallery') }}</h4>
                                ...
                                <div class="col-4">
                                    <div class="input-block">
                                        ...
                                        <input type="file" class="form-control" name="image"
                                            wire:model="imageUpload" multiple />
                                        @error('imageUpload')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    @if (!empty($photoEdit))
                                        @foreach ($photoEdit as $imgId => $img)
                                            <div style="display: inline-block; position: relative;">
                                                <img src="{{ asset('storage/image_gallery/' . $img) }}"
