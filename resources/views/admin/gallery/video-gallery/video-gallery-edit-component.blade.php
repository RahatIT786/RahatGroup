<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ __('tablevars.edit') }} {{ __('tablevars.video_gallery') }}</h1>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.edit') }} {{ __('tablevars.video_gallery') }}</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        @foreach ($existingVideos as $index => $videoData)
                                            <div class="d-flex mb-2">
                                                <input type="text" name="video[{{ $index }}]" class="form-control" wire:model="existingVideos.{{ $index }}.video">
                                                <button type="button" class="btn btn-danger ml-2" wire:click="removeVideo({{ $index }})">Remove</button>
                                            </div>
                                            @error('existingVideos.' . $index . '.video')
                                                <span class="v-msg">{{ $message }}</span>
                                            @enderror
                                        @endforeach
                                    </div>
