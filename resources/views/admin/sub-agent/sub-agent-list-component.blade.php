    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.payment.index') }}" wire:navigate>{{ __('tablevars.subagent') }}</a></div>
                <div class="breadcrumb-item">{{ __('tablevars.all') }} {{ __('tablevars.subagent') }}</div>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4 mb-2">
                                    <label class="label-header" for="search_name">Sub Agent Name</label>
                                    <input type="text" name="search_name" id="search_name" class="form-control"
                                        placeholder="Search Sub Agent Name" autocomplete="off">
                                </div>
                                {{-- <div class="col-4 mb-2">
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                           ...
                                           <th>Agency Code</th>
                                           <th>Agency</th>
                                           <th class="no-wrap">Sub Agent Name</th>
                                           {{-- <th>City</th> --}}
                                           <th>Mobile</th>
                                           {{-- <th>Email</th> --}}
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            {{-- <td>Gujranwala</td> --}}
                                            <td>9851207775</td>
                                            {{-- <td>kalimiumrahtour@gmail.com</td> --}}
                                            <td>
