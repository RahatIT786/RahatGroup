                            ...
                            <div class="row">
                                <div class="col-3">
                                    <label class="label-header"
                                        for="search_type">{{ 'Type' }}</label>
                                    <input type="text" name="search_type" id="search_type"
                                        class="form-control" placeholder="Search Type" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <div class="badge badge-primary mr-2"><span class="text-bold text-dark">Primary</span>
                                </div>
                                <div class="badge badge-secondary mr-2"><span
                                        class="text-bold text-dark">Secondary</span>
                                </div>
                                <div class="badge badge-success mr-2"><span class="text-bold text-white">Success</span>
                                </div>
                                <div class="badge badge-danger mr-2"><span class="text-bold text-dark">Danger</span>
                                </div>
                                <div class="badge badge-warning mr-2"><span class="text-bold text-dark">Warning</span>
                                </div>
                                <div class="badge badge-info mr-2"><span class="text-bold text-dark">Info</span>
                                </div>
                                <div class="badge badge-dark mr-2"><span class="text-bold text-white">Dark</span>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                <label>{{ __('tablevars.header_content') }}</label><span class="text-danger">*</span>
