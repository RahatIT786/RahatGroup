<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ __('tablevars.edit') }} {{ __('tablevars.service') }}</h1>
                ...
                <div class="card card-primary">
                    <form id="form" wire:submit.prevent="update">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.edit') }} {{ __('tablevars.service') }}</h4>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @elseif (!empty($service_imgEdit))
                                        <img src="{{ asset('storage/service_image/' . $service_imgEdit) }}"
                                            style="height: 100px;">
                                    @else
