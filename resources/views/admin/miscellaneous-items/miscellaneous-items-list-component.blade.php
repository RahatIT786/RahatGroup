    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active">{{ __('tablevars.miscellaneous_items') }}
                ...
                <div class="breadcrumb-item">{{ __('tablevars.all') }} {{ __('tablevars.miscellaneous_items') }}</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            {{-- <a href="{{ route('admin.miscellaneousItems.create') }}" class="btn btn-primary"
                            ...
                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                ...
                                data-toggle="tooltip" title="Add Miscellaneous Items">{{ __('tablevars.add') }}
                                {{ __('tablevars.new') }}</a>
                        </div>
                        <div class="card-body">
            ...
            <div class="modal-content">
                ...
                <form>
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="items" class="form-label">{{ __('tablevars.items') }}<span
                        ...
                        <div class="mb-3">
                            <label for="value" class="form-label">{{ __('tablevars.value') }}<span
                                    class="text-danger">*</span></label>
        ...
        <div class="modal-content">
            ...
            <form>
                <div class="modal-body">
                    <!-- Add your form fields here -->
                    <div class="mb-3">
                        <label>{{ __('tablevars.items') }} {{ __('tablevars.name') }}<span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="items_name" value="Umrah Kit"
                            id="items_name" placeholder="Please enter items name">
                        @error('items_name')
                            <span class="v-msg-500">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mb-3">
                        <label>{{ __('tablevars.items') }} {{ __('tablevars.value') }}<span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="items_name" value="560 INR"
                            id="items_name" placeholder="Please enter items name">
                        @error('items_name')
                            <span class="v-msg-500">{{ $message }}</span>
                        @enderror
