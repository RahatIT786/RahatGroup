<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ __('tablevars.edit') }} {{ __('tablevars.new') }} {{ __('tablevars.pnr') }}</h1>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.edit') }} {{ __('tablevars.pnr') }}</h4>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group" wire:ignore>
                                        ...
                                        <select class="form-control" wire:model="pack_id" id="pack_id" name="pack_id"
                                            ...
                                            @foreach ($packageTypes as $id => $package_name)
                                ...
                                {{-- <div class="col-4">
                                    <div class="form-group">
                                        <label>Transport BRN Number<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" placeholder="Enter BRN Number"
                                            wire:model="transport_brn">
                                        @error('transport_brn')
                                            <span class="v-msg-500">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                {{-- <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <select class="form-control" wire:model="dept_time_hour">
                                                        <option value="">In Hours</option>
                                                        @foreach (range(0, 23) as $v)
                                                            <option value="{{ str_pad($v, 2, '0', STR_PAD_LEFT) }}">
                                                                {{ str_pad($v, 2, '0', STR_PAD_LEFT) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-6">
                                                    <select class="form-control" wire:model="dept_time_minute">
                                                        <option value="">In Minute</option>
                                            ...
                                            @error('dept_time_hour')
                                                <span class="v-msg-500">{{ $message }}</span>
                                            @enderror
                                            @error('dept_time_minute')
                                                <span class="v-msg-500">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    </div>
                                ...
                                {{-- <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <select class="form-control" wire:model="return_time_hour">
                                                        <option value="">In Hours</option>
                                                        @foreach (range(0, 23) as $v)
                                                            <option value="{{ str_pad($v, 2, '0', STR_PAD_LEFT) }}">
                                                                {{ str_pad($v, 2, '0', STR_PAD_LEFT) }}</option>
                                                ...
                                                <div class="col-md-6">
                                                    <select class="form-control" wire:model="return_time_minute">
                                                        <option value="">In Minute</option>
                                                        @foreach (range(0, 59) as $v)
                                                            <option value="{{ str_pad($v, 2, '0', STR_PAD_LEFT) }}">
                                                                {{ str_pad($v, 2, '0', STR_PAD_LEFT) }}</option>
                                            ...
                                            @error('return_time_hour')
                                                <span class="v-msg-500">{{ $message }}</span>
                                            @enderror
                                            @error('return_time_minute')
                                                <span class="v-msg-500">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    </div>
                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <label>Package Leader<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control"
                                            placeholder="Enter Name of Package Leader" wire:model="tour_leader">
                                        @error('tour_leader')
                                            <span class="v-msg-500">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            placeholder="Enter Name of Supplier" wire:model="supp_name">
                                        @error('supp_name')
                                            <span class="v-msg-500">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <label>Transport Company Name<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" wire:model="transco_name"
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <label>Transport Company Phone<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" wire:model="mobno_tc"
                                            placeholder="Enter Transport Company Phone"
                                            onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                            maxlength="18">
                                        @error('mobno_tc')
                                            <span class="v-msg-500">{{ $message }}</span>
...
@push('extra_js')
    <script>
        $(document).ready(function() {
            $('#pack_id').select2();
            $('#pack_id').val(@this.pack_id).trigger('change');
            $('#pack_id').on('change', function(e) {
                var data = $('#pack_id').select2("val");
