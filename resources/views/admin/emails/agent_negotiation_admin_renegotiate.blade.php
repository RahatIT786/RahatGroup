...
<head>
    <title>Request Renegotiation</title>
    <style>
...
background-position: top; padding: 20px;">
        <div class="email-container">
            <div style="padding: 20px;">
                ...
                <div class="header">
                    <h1>Booking Negotiation Updated</h1>
                </div>
                <div class="content">
                    <p>Dear {{ $booking->customer_name }},</p>
                    <p>Your booking negotiation has been changed. Below are the details of your booking:</p>
                    ...
                    <table>
                        ...
                        <tr>
                            <th>Updated Negotiation</th>
                            <td>{{ $booking->negotiated_cost }}</td>
                        </tr>
                    </table>
