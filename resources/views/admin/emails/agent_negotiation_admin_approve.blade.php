...
<head>
    <title>Booking Negotiation {{ ucfirst($status) }}</title>
    <style>
...
background-position: top; padding: 20px;">
        <div class="email-container">
            <div style="padding: 20px;">
                ...
                <div class="header">
                    <h1>Booking Negotiation {{ ucfirst($status) }}</h1>
                </div>
                <div class="content">
                    <p>Dear {{ $booking->customer_name }},</p>
                    <p>Your booking negotiation has been <strong>{{ $status }}</strong>. Below are the details of
                        your booking:</p>
                ...
                <div class="footer">
                    <p style="text-align: left;">Best regards,<br>Booking Team</p>
                </div>
                <div class="footer">
                    ...
                    <table style="background: #333333;width:100%;color:#ffffff;">
                        ...
                        <tr>
                            <td style="text-align: right;width:50%;padding-right:20px;">
                                <p class="footer-link"><strong>Email :</strong> <a href="{{ $admin_email }}"
                                        style="color: #ffffff">{{ $admin_email }}</a></p>
                            </td>
                            <td style="width:50%;">
