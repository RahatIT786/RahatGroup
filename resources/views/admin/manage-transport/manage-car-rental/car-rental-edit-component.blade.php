<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ __('tablevars.edit') }} {{ __('tablevars.car_rental') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active">{{ __('tablevars.car_rental') }} {{ __('tablevars.managment') }}
                </div>
                ...
                <div class="breadcrumb-item">{{ __('tablevars.edit') }} {{ __('tablevars.car_rental') }}</div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card card-primary">
                    <form wire:submit.prevent="update">
                        <div class="card-header d-flex justify-content-between">
                            <h4>{{ __('tablevars.edit') }} {{ __('tablevars.car_rental') }}</h4>
                            <a href="{{ route('admin.manageCarRental.index') }}" class="btn btn-danger" wire:navigate>
                                    ...
                                    @if ($oldimage && !$image)
                                        @foreach ($oldimage as $imgId => $img)
                                            <div style="display: inline-block; position: relative;">
                                                <img src="{{ asset('storage/car_image/' . $img) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="input-block" wire:ignore>
                                            ...
                                            <textarea type="text" input="description" class="form-control summernote" wire:model='description'
