    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active">{{ __('tablevars.manage_beneficiary') }}
                    {{ __('tablevars.managment') }}
                </div>
                <div class="breadcrumb-item"><a href="{{ route('admin.beneficiary.index') }}"
                        wire:navigate>{{ __('tablevars.manage_beneficiary') }}</a></div>
                <div class="breadcrumb-item">{{ __('tablevars.all') }} {{ __('tablevars.manage_beneficiary') }}</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            {{-- <a href="{{ route('admin.beneficiary.create') }}" class="btn btn-primary"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">{{ __('tablevars.manage_beneficiary') }}</h5>
                ...
                <form>
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="beneficiary" class="form-label">{{ __('tablevars.beneficiary') }}
                                {{ __('tablevars.name') }}</label>
                            <input type="text" class="form-control" name="beneficiary" id="beneficiary">
                            @error('beneficiary')
